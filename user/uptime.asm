...
int main(){
  ...
  16:	79e50513          	addi	a0,a0,1950 # 7b0 <malloc+0xe6>
  1a:	00000097          	auipc	ra,0x0
  1e:	5f8080e7          	jalr	1528(ra) # 612 <printf>
    exit(0);
  22:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 380:	4a450513          	addi	a0,a0,1188 # 820 <digits>
 384:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 440:	38cc8c93          	addi	s9,s9,908 # 7c8 <malloc+0xfe>
 ...
 44e:	3d6b8b93          	addi	s7,s7,982 # 820 <digits>
 ...
 574:	25098993          	addi	s3,s3,592 # 7c0 <malloc+0xf6>
        while(*s != 0){
 578:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 656:	1e67b783          	ld	a5,486(a5) # 838 <freep>
 ...
 67e:	00e6ea63          	bltu	a3,a4,692 <free+0x4a>
{
 ...
 6c0:	16f73e23          	sd	a5,380(a4) # 838 <freep>
}
 6c4:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 6f2:	14a53503          	ld	a0,330(a0) # 838 <freep>
 ...
 71a:	12290913          	addi	s2,s2,290 # 838 <freep>
  if(p == (char*)-1)
 71e:	5afd                	li	s5,-1
 720:	a895                	j	794 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 722:	00000797          	auipc	a5,0x0
 726:	11e78793          	addi	a5,a5,286 # 840 <base>
 72a:	00000717          	auipc	a4,0x0
 72e:	10f73723          	sd	a5,270(a4) # 838 <freep>
 732:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 756:	0ea73323          	sd	a0,230(a4) # 838 <freep>
      return (void*)(p + 1);
 ...
 7a4:	b80080e7          	jalr	-1152(ra) # 320 <sbrk>
  if(p == (char*)-1)
