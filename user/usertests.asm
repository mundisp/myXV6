...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	d6250513          	addi	a0,a0,-670 # 5da0 <malloc+0xec>
      46:	00006097          	auipc	ra,0x6
      4a:	bb6080e7          	jalr	-1098(ra) # 5bfc <printf>
      exit(1);
      4e:	4505                	li	a0,1
      ...
      74:	8082                	ret
{
      ...
      84:	d4050513          	addi	a0,a0,-704 # 5dc0 <malloc+0x10c>
      88:	00006097          	auipc	ra,0x6
      8c:	b74080e7          	jalr	-1164(ra) # 5bfc <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	d3050513          	addi	a0,a0,-720 # 5dd8 <malloc+0x124>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	d3250513          	addi	a0,a0,-718 # 5df8 <malloc+0x144>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	cfa50513          	addi	a0,a0,-774 # 5de0 <malloc+0x12c>
      ee:	00006097          	auipc	ra,0x6
      f2:	b0e080e7          	jalr	-1266(ra) # 5bfc <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	d0650513          	addi	a0,a0,-762 # 5e08 <malloc+0x154>
     10a:	00006097          	auipc	ra,0x6
     10e:	af2080e7          	jalr	-1294(ra) # 5bfc <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	d0450513          	addi	a0,a0,-764 # 5e30 <malloc+0x17c>
     134:	00005097          	auipc	ra,0x5
     138:	75e080e7          	jalr	1886(ra) # 5892 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	cf050513          	addi	a0,a0,-784 # 5e30 <malloc+0x17c>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	cec58593          	addi	a1,a1,-788 # 5e40 <malloc+0x18c>
     15c:	00005097          	auipc	ra,0x5
     160:	706080e7          	jalr	1798(ra) # 5862 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	cc850513          	addi	a0,a0,-824 # 5e30 <malloc+0x17c>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	ccc58593          	addi	a1,a1,-820 # 5e48 <malloc+0x194>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	c9c50513          	addi	a0,a0,-868 # 5e30 <malloc+0x17c>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	c8650513          	addi	a0,a0,-890 # 5e50 <malloc+0x19c>
     1d2:	00006097          	auipc	ra,0x6
     1d6:	a2a080e7          	jalr	-1494(ra) # 5bfc <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	bfc50513          	addi	a0,a0,-1028 # 5e78 <malloc+0x1c4>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	be8a8a93          	addi	s5,s5,-1048 # 5e78 <malloc+0x1c4>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	b7650513          	addi	a0,a0,-1162 # 5e88 <malloc+0x1d4>
     31a:	00006097          	auipc	ra,0x6
     31e:	8e2080e7          	jalr	-1822(ra) # 5bfc <printf>
      exit(1);
     322:	4505                	li	a0,1
     ...
     338:	b7450513          	addi	a0,a0,-1164 # 5ea8 <malloc+0x1f4>
     33c:	00006097          	auipc	ra,0x6
     340:	8c0080e7          	jalr	-1856(ra) # 5bfc <printf>
        exit(1);
     344:	4505                	li	a0,1
...
000000000000034e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     374:	b50a0a13          	addi	s4,s4,-1200 # 5ec0 <malloc+0x20c>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     420:	aac50513          	addi	a0,a0,-1364 # 5ec8 <malloc+0x214>
     424:	00005097          	auipc	ra,0x5
     428:	7d8080e7          	jalr	2008(ra) # 5bfc <printf>
      exit(1);
     42c:	4505                	li	a0,1
     ...
     43e:	aa650513          	addi	a0,a0,-1370 # 5ee0 <malloc+0x22c>
     442:	00005097          	auipc	ra,0x5
     446:	7ba080e7          	jalr	1978(ra) # 5bfc <printf>
      exit(1);
     44a:	4505                	li	a0,1
     ...
     45c:	ab850513          	addi	a0,a0,-1352 # 5f10 <malloc+0x25c>
     460:	00005097          	auipc	ra,0x5
     464:	79c080e7          	jalr	1948(ra) # 5bfc <printf>
      exit(1);
     468:	4505                	li	a0,1
     ...
     476:	ace50513          	addi	a0,a0,-1330 # 5f40 <malloc+0x28c>
     47a:	00005097          	auipc	ra,0x5
     47e:	782080e7          	jalr	1922(ra) # 5bfc <printf>
      exit(1);
     482:	4505                	li	a0,1
     ...
     494:	ac050513          	addi	a0,a0,-1344 # 5f50 <malloc+0x29c>
     498:	00005097          	auipc	ra,0x5
     49c:	764080e7          	jalr	1892(ra) # 5bfc <printf>
      exit(1);
     4a0:	4505                	li	a0,1
...
00000000000004aa <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d2:	ab2a0a13          	addi	s4,s4,-1358 # 5f80 <malloc+0x2cc>
    n = write(fds[1], "x", 1);
     4d6:	00006a97          	auipc	s5,0x6
     4da:	972a8a93          	addi	s5,s5,-1678 # 5e48 <malloc+0x194>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     580:	a0c50513          	addi	a0,a0,-1524 # 5f88 <malloc+0x2d4>
     584:	00005097          	auipc	ra,0x5
     588:	678080e7          	jalr	1656(ra) # 5bfc <printf>
      exit(1);
     58c:	4505                	li	a0,1
     ...
     59e:	a0650513          	addi	a0,a0,-1530 # 5fa0 <malloc+0x2ec>
     5a2:	00005097          	auipc	ra,0x5
     5a6:	65a080e7          	jalr	1626(ra) # 5bfc <printf>
      exit(1);
     5aa:	4505                	li	a0,1
     ...
     5b8:	98c50513          	addi	a0,a0,-1652 # 5f40 <malloc+0x28c>
     5bc:	00005097          	auipc	ra,0x5
     5c0:	640080e7          	jalr	1600(ra) # 5bfc <printf>
      exit(1);
     5c4:	4505                	li	a0,1
     ...
     5d2:	a0250513          	addi	a0,a0,-1534 # 5fd0 <malloc+0x31c>
     5d6:	00005097          	auipc	ra,0x5
     5da:	626080e7          	jalr	1574(ra) # 5bfc <printf>
      exit(1);
     5de:	4505                	li	a0,1
     ...
     5f0:	9fc50513          	addi	a0,a0,-1540 # 5fe8 <malloc+0x334>
     5f4:	00005097          	auipc	ra,0x5
     5f8:	608080e7          	jalr	1544(ra) # 5bfc <printf>
      exit(1);
     5fc:	4505                	li	a0,1
...
0000000000000606 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     646:	7fe58593          	addi	a1,a1,2046 # 5e40 <malloc+0x18c>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     662:	7d250513          	addi	a0,a0,2002 # 5e30 <malloc+0x17c>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     68e:	7a650513          	addi	a0,a0,1958 # 5e30 <malloc+0x17c>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a2:	79250513          	addi	a0,a0,1938 # 5e30 <malloc+0x17c>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e0:	99c58593          	addi	a1,a1,-1636 # 6078 <malloc+0x3c4>
     6e4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     722:	71250513          	addi	a0,a0,1810 # 5e30 <malloc+0x17c>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     766:	8b650513          	addi	a0,a0,-1866 # 6018 <malloc+0x364>
     76a:	00005097          	auipc	ra,0x5
     76e:	492080e7          	jalr	1170(ra) # 5bfc <printf>
    exit(1);
     772:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     782:	8ba50513          	addi	a0,a0,-1862 # 6038 <malloc+0x384>
     786:	00005097          	auipc	ra,0x5
     78a:	476080e7          	jalr	1142(ra) # 5bfc <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     78e:	8652                	mv	a2,s4
     790:	85d6                	mv	a1,s5
     792:	00006517          	auipc	a0,0x6
     796:	8b650513          	addi	a0,a0,-1866 # 6048 <malloc+0x394>
     79a:	00005097          	auipc	ra,0x5
     79e:	462080e7          	jalr	1122(ra) # 5bfc <printf>
    exit(1);
     7a2:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b2:	8ba50513          	addi	a0,a0,-1862 # 6068 <malloc+0x3b4>
     7b6:	00005097          	auipc	ra,0x5
     7ba:	446080e7          	jalr	1094(ra) # 5bfc <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7be:	8652                	mv	a2,s4
     7c0:	85d6                	mv	a1,s5
     7c2:	00006517          	auipc	a0,0x6
     7c6:	88650513          	addi	a0,a0,-1914 # 6048 <malloc+0x394>
     7ca:	00005097          	auipc	ra,0x5
     7ce:	432080e7          	jalr	1074(ra) # 5bfc <printf>
    exit(1);
     7d2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e4:	8a050513          	addi	a0,a0,-1888 # 6080 <malloc+0x3cc>
     7e8:	00005097          	auipc	ra,0x5
     7ec:	414080e7          	jalr	1044(ra) # 5bfc <printf>
    exit(1);
     7f0:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     802:	8a250513          	addi	a0,a0,-1886 # 60a0 <malloc+0x3ec>
     806:	00005097          	auipc	ra,0x5
     80a:	3f6080e7          	jalr	1014(ra) # 5bfc <printf>
    exit(1);
     80e:	4505                	li	a0,1
...
0000000000000818 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     836:	88e50513          	addi	a0,a0,-1906 # 60c0 <malloc+0x40c>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     84e:	89e98993          	addi	s3,s3,-1890 # 60e8 <malloc+0x434>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     852:	00006a97          	auipc	s5,0x6
     856:	8cea8a93          	addi	s5,s5,-1842 # 6120 <malloc+0x46c>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89c:	82850513          	addi	a0,a0,-2008 # 60c0 <malloc+0x40c>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8b6:	56658593          	addi	a1,a1,1382 # be18 <buf>
  ...
  if(unlink("small") < 0){
     ...
     8d8:	7ec50513          	addi	a0,a0,2028 # 60c0 <malloc+0x40c>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     902:	7ca50513          	addi	a0,a0,1994 # 60c8 <malloc+0x414>
     906:	00005097          	auipc	ra,0x5
     90a:	2f6080e7          	jalr	758(ra) # 5bfc <printf>
    exit(1);
     90e:	4505                	li	a0,1
     ...
     920:	7dc50513          	addi	a0,a0,2012 # 60f8 <malloc+0x444>
     924:	00005097          	auipc	ra,0x5
     928:	2d8080e7          	jalr	728(ra) # 5bfc <printf>
      exit(1);
     92c:	4505                	li	a0,1
     ...
     93e:	7f650513          	addi	a0,a0,2038 # 6130 <malloc+0x47c>
     942:	00005097          	auipc	ra,0x5
     946:	2ba080e7          	jalr	698(ra) # 5bfc <printf>
      exit(1);
     94a:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95a:	80250513          	addi	a0,a0,-2046 # 6158 <malloc+0x4a4>
     95e:	00005097          	auipc	ra,0x5
     962:	29e080e7          	jalr	670(ra) # 5bfc <printf>
    exit(1);
     966:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     976:	80650513          	addi	a0,a0,-2042 # 6178 <malloc+0x4c4>
     97a:	00005097          	auipc	ra,0x5
     97e:	282080e7          	jalr	642(ra) # 5bfc <printf>
    exit(1);
     982:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     992:	80250513          	addi	a0,a0,-2046 # 6190 <malloc+0x4dc>
     996:	00005097          	auipc	ra,0x5
     99a:	266080e7          	jalr	614(ra) # 5bfc <printf>
    exit(1);
     99e:	4505                	li	a0,1
...
00000000000009a8 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c4:	7f050513          	addi	a0,a0,2032 # 61b0 <malloc+0x4fc>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9d8:	44490913          	addi	s2,s2,1092 # be18 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     a16:	79e50513          	addi	a0,a0,1950 # 61b0 <malloc+0x4fc>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a2a:	3f290913          	addi	s2,s2,1010 # be18 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a5e:	75e50513          	addi	a0,a0,1886 # 61b8 <malloc+0x504>
     a62:	00005097          	auipc	ra,0x5
     a66:	19a080e7          	jalr	410(ra) # 5bfc <printf>
    exit(1);
     a6a:	4505                	li	a0,1
     ...
     a7c:	76050513          	addi	a0,a0,1888 # 61d8 <malloc+0x524>
     a80:	00005097          	auipc	ra,0x5
     a84:	17c080e7          	jalr	380(ra) # 5bfc <printf>
      exit(1);
     a88:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a98:	76c50513          	addi	a0,a0,1900 # 6200 <malloc+0x54c>
     a9c:	00005097          	auipc	ra,0x5
     aa0:	160080e7          	jalr	352(ra) # 5bfc <printf>
    exit(1);
     aa4:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ac4:	6f050513          	addi	a0,a0,1776 # 61b0 <malloc+0x4fc>
     ...
     af0:	73450513          	addi	a0,a0,1844 # 6220 <malloc+0x56c>
     af4:	00005097          	auipc	ra,0x5
     af8:	108080e7          	jalr	264(ra) # 5bfc <printf>
        exit(1);
     afc:	4505                	li	a0,1
     ...
     b0e:	73e50513          	addi	a0,a0,1854 # 6248 <malloc+0x594>
     b12:	00005097          	auipc	ra,0x5
     b16:	0ea080e7          	jalr	234(ra) # 5bfc <printf>
      exit(1);
     b1a:	4505                	li	a0,1
     ...
     b2c:	73850513          	addi	a0,a0,1848 # 6260 <malloc+0x5ac>
     b30:	00005097          	auipc	ra,0x5
     b34:	0cc080e7          	jalr	204(ra) # 5bfc <printf>
      exit(1);
     b38:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b48:	74450513          	addi	a0,a0,1860 # 6288 <malloc+0x5d4>
     b4c:	00005097          	auipc	ra,0x5
     b50:	0b0080e7          	jalr	176(ra) # 5bfc <printf>
    exit(1);
     b54:	4505                	li	a0,1
...
0000000000000b5e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b76:	72e50513          	addi	a0,a0,1838 # 62a0 <malloc+0x5ec>
  ...
  write(fd, "hello", SZ);
     ...
     b8e:	74658593          	addi	a1,a1,1862 # 62d0 <malloc+0x61c>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     baa:	6fa50513          	addi	a0,a0,1786 # 62a0 <malloc+0x5ec>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc0:	6e450513          	addi	a0,a0,1764 # 62a0 <malloc+0x5ec>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd6:	6ce50513          	addi	a0,a0,1742 # 62a0 <malloc+0x5ec>
  ...
  write(fd1, "yyy", 3);
     ...
     bea:	73258593          	addi	a1,a1,1842 # 6318 <malloc+0x664>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c06:	21658593          	addi	a1,a1,534 # be18 <buf>
     c0a:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c52:	65250513          	addi	a0,a0,1618 # 62a0 <malloc+0x5ec>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c72:	64250513          	addi	a0,a0,1602 # 62b0 <malloc+0x5fc>
     c76:	00005097          	auipc	ra,0x5
     c7a:	f86080e7          	jalr	-122(ra) # 5bfc <printf>
    exit(1);
     c7e:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c8e:	64e50513          	addi	a0,a0,1614 # 62d8 <malloc+0x624>
     c92:	00005097          	auipc	ra,0x5
     c96:	f6a080e7          	jalr	-150(ra) # 5bfc <printf>
    exit(1);
     c9a:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     caa:	65250513          	addi	a0,a0,1618 # 62f8 <malloc+0x644>
     cae:	00005097          	auipc	ra,0x5
     cb2:	f4e080e7          	jalr	-178(ra) # 5bfc <printf>
    exit(1);
     cb6:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc6:	65e50513          	addi	a0,a0,1630 # 6320 <malloc+0x66c>
     cca:	00005097          	auipc	ra,0x5
     cce:	f32080e7          	jalr	-206(ra) # 5bfc <printf>
    exit(1);
     cd2:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce2:	66250513          	addi	a0,a0,1634 # 6340 <malloc+0x68c>
     ce6:	00005097          	auipc	ra,0x5
     cea:	f16080e7          	jalr	-234(ra) # 5bfc <printf>
    exit(1);
     cee:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     cfe:	66650513          	addi	a0,a0,1638 # 6360 <malloc+0x6ac>
     d02:	00005097          	auipc	ra,0x5
     d06:	efa080e7          	jalr	-262(ra) # 5bfc <printf>
    exit(1);
     d0a:	4505                	li	a0,1
...
0000000000000d14 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d62:	57258593          	addi	a1,a1,1394 # 62d0 <malloc+0x61c>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d82:	60a58593          	addi	a1,a1,1546 # 6388 <malloc+0x6d4>
     d86:	00005517          	auipc	a0,0x5
     d8a:	5fa50513          	addi	a0,a0,1530 # 6380 <malloc+0x6cc>
  ...
  unlink("lf1");
     ...
     d9e:	5e650513          	addi	a0,a0,1510 # 6380 <malloc+0x6cc>
     da2:	00005097          	auipc	ra,0x5
     da6:	af0080e7          	jalr	-1296(ra) # 5892 <unlink>
  if(open("lf1", 0) >= 0){
     daa:	4581                	li	a1,0
     dac:	00005517          	auipc	a0,0x5
     db0:	5d450513          	addi	a0,a0,1492 # 6380 <malloc+0x6cc>
  ...
  fd = open("lf2", 0);
     ...
     dc6:	5c650513          	addi	a0,a0,1478 # 6388 <malloc+0x6d4>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     dde:	03e58593          	addi	a1,a1,62 # be18 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     dfe:	58e58593          	addi	a1,a1,1422 # 6388 <malloc+0x6d4>
     e02:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e14:	57850513          	addi	a0,a0,1400 # 6388 <malloc+0x6d4>
     e18:	00005097          	auipc	ra,0x5
     e1c:	a7a080e7          	jalr	-1414(ra) # 5892 <unlink>
  if(link("lf2", "lf1") >= 0){
     e20:	00005597          	auipc	a1,0x5
     e24:	56058593          	addi	a1,a1,1376 # 6380 <malloc+0x6cc>
     e28:	00005517          	auipc	a0,0x5
     e2c:	56050513          	addi	a0,a0,1376 # 6388 <malloc+0x6d4>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e40:	54458593          	addi	a1,a1,1348 # 6380 <malloc+0x6cc>
     e44:	00005517          	auipc	a0,0x5
     e48:	64c50513          	addi	a0,a0,1612 # 6490 <malloc+0x7dc>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6a:	52a50513          	addi	a0,a0,1322 # 6390 <malloc+0x6dc>
     e6e:	00005097          	auipc	ra,0x5
     e72:	d8e080e7          	jalr	-626(ra) # 5bfc <printf>
    exit(1);
     e76:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e86:	52650513          	addi	a0,a0,1318 # 63a8 <malloc+0x6f4>
     e8a:	00005097          	auipc	ra,0x5
     e8e:	d72080e7          	jalr	-654(ra) # 5bfc <printf>
    exit(1);
     e92:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea2:	52250513          	addi	a0,a0,1314 # 63c0 <malloc+0x70c>
     ea6:	00005097          	auipc	ra,0x5
     eaa:	d56080e7          	jalr	-682(ra) # 5bfc <printf>
    exit(1);
     eae:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ebe:	52650513          	addi	a0,a0,1318 # 63e0 <malloc+0x72c>
     ec2:	00005097          	auipc	ra,0x5
     ec6:	d3a080e7          	jalr	-710(ra) # 5bfc <printf>
    exit(1);
     eca:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     eda:	53a50513          	addi	a0,a0,1338 # 6410 <malloc+0x75c>
     ede:	00005097          	auipc	ra,0x5
     ee2:	d1e080e7          	jalr	-738(ra) # 5bfc <printf>
    exit(1);
     ee6:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef6:	53650513          	addi	a0,a0,1334 # 6428 <malloc+0x774>
     efa:	00005097          	auipc	ra,0x5
     efe:	d02080e7          	jalr	-766(ra) # 5bfc <printf>
    exit(1);
     f02:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f12:	53250513          	addi	a0,a0,1330 # 6440 <malloc+0x78c>
     f16:	00005097          	auipc	ra,0x5
     f1a:	ce6080e7          	jalr	-794(ra) # 5bfc <printf>
    exit(1);
     f1e:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     f2e:	53e50513          	addi	a0,a0,1342 # 6468 <malloc+0x7b4>
     f32:	00005097          	auipc	ra,0x5
     f36:	cca080e7          	jalr	-822(ra) # 5bfc <printf>
    exit(1);
     f3a:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4a:	55250513          	addi	a0,a0,1362 # 6498 <malloc+0x7e4>
     f4e:	00005097          	auipc	ra,0x5
     f52:	cae080e7          	jalr	-850(ra) # 5bfc <printf>
    exit(1);
     f56:	4505                	li	a0,1
...
0000000000000f60 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb0:	50ca0a13          	addi	s4,s4,1292 # 64b8 <malloc+0x804>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1002:	4ba50513          	addi	a0,a0,1210 # 64b8 <malloc+0x804>
  ...
  for(i = 0; i < N; i++){
    ...
    1072:	45250513          	addi	a0,a0,1106 # 64c0 <malloc+0x80c>
    1076:	00005097          	auipc	ra,0x5
    107a:	b86080e7          	jalr	-1146(ra) # 5bfc <printf>
    exit(1);
    107e:	4505                	li	a0,1
    ...
    1092:	45250513          	addi	a0,a0,1106 # 64e0 <malloc+0x82c>
    1096:	00005097          	auipc	ra,0x5
    109a:	b66080e7          	jalr	-1178(ra) # 5bfc <printf>
      exit(1);
    109e:	4505                	li	a0,1
    ...
    10ae:	45650513          	addi	a0,a0,1110 # 6500 <malloc+0x84c>
    10b2:	00005097          	auipc	ra,0x5
    10b6:	b4a080e7          	jalr	-1206(ra) # 5bfc <printf>
      exit(1);
    10ba:	4505                	li	a0,1
...
00000000000010c4 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e0:	44498993          	addi	s3,s3,1092 # 6520 <malloc+0x86c>
    10e4:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111c:	41850513          	addi	a0,a0,1048 # 6530 <malloc+0x87c>
    1120:	00005097          	auipc	ra,0x5
    1124:	adc080e7          	jalr	-1316(ra) # 5bfc <printf>
      exit(1);
    1128:	4505                	li	a0,1
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1144:	4b04b483          	ld	s1,1200(s1) # 85f0 <__SDATA_BEGIN__>
...
badarg(char *s)
{
    ...
    117a:	35048493          	addi	s1,s1,848 # c350 <buf+0x538>
  for(int i = 0; i < 50000; i++){
    ...
    1188:	c5498993          	addi	s3,s3,-940 # 5dd8 <malloc+0x124>
    argv[0] = (char*)0xffffffff;
...
00000000000011b0 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1212:	51a78793          	addi	a5,a5,1306 # 7728 <malloc+0x1a74>
  ...
  if(pid == 0){
    ...
    1248:	4bc78793          	addi	a5,a5,1212 # 8700 <big.0>
    124c:	00008697          	auipc	a3,0x8
    1250:	4b468693          	addi	a3,a3,1204 # 9700 <__global_pointer$+0x910>
      big[i] = 'x';
    ...
    1266:	48078f23          	sb	zero,1182(a5) # 9700 <__global_pointer$+0x910>
    char *args2[] = { big, big, big, 0 };
    126a:	00007797          	auipc	a5,0x7
    126e:	efe78793          	addi	a5,a5,-258 # 8168 <malloc+0x24b4>
    ...
    1292:	b4a50513          	addi	a0,a0,-1206 # 5dd8 <malloc+0x124>
    ...
    12aa:	33250513          	addi	a0,a0,818 # 65d8 <malloc+0x924>
    12ae:	00005097          	auipc	ra,0x5
    12b2:	94e080e7          	jalr	-1714(ra) # 5bfc <printf>
      exit(1);
    12b6:	4505                	li	a0,1
    ...
    12ca:	28a50513          	addi	a0,a0,650 # 6550 <malloc+0x89c>
    12ce:	00005097          	auipc	ra,0x5
    12d2:	92e080e7          	jalr	-1746(ra) # 5bfc <printf>
    exit(1);
    12d6:	4505                	li	a0,1
    ...
    12ea:	28a50513          	addi	a0,a0,650 # 6570 <malloc+0x8bc>
    12ee:	00005097          	auipc	ra,0x5
    12f2:	90e080e7          	jalr	-1778(ra) # 5bfc <printf>
    exit(1);
    12f6:	4505                	li	a0,1
    ...
    130c:	28850513          	addi	a0,a0,648 # 6590 <malloc+0x8dc>
    1310:	00005097          	auipc	ra,0x5
    1314:	8ec080e7          	jalr	-1812(ra) # 5bfc <printf>
    exit(1);
    1318:	4505                	li	a0,1
    ...
    132c:	29050513          	addi	a0,a0,656 # 65b8 <malloc+0x904>
    1330:	00005097          	auipc	ra,0x5
    1334:	8cc080e7          	jalr	-1844(ra) # 5bfc <printf>
    exit(1);
    1338:	4505                	li	a0,1
    ...
    1346:	70e50513          	addi	a0,a0,1806 # 6a50 <malloc+0xd9c>
    134a:	00005097          	auipc	ra,0x5
    134e:	8b2080e7          	jalr	-1870(ra) # 5bfc <printf>
    exit(1);
    1352:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1390:	27450513          	addi	a0,a0,628 # 6600 <malloc+0x94c>
    1394:	00005097          	auipc	ra,0x5
    1398:	868080e7          	jalr	-1944(ra) # 5bfc <printf>
    exit(1);
    139c:	4505                	li	a0,1
...
00000000000013a6 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c2:	a7250513          	addi	a0,a0,-1422 # 5e30 <malloc+0x17c>
  ...
  if(pid == 0){
    ...
    13ec:	a48a0a13          	addi	s4,s4,-1464 # 5e30 <malloc+0x17c>
      int n = write(fd, "1234567890", 10);
    13f0:	00005a97          	auipc	s5,0x5
    13f4:	270a8a93          	addi	s5,s5,624 # 6660 <malloc+0x9ac>
      int fd = open("truncfile", O_WRONLY);
    13f8:	4585                	li	a1,1
    13fa:	8552                	mv	a0,s4
    ...
    1464:	1d050513          	addi	a0,a0,464 # 6630 <malloc+0x97c>
    1468:	00004097          	auipc	ra,0x4
    146c:	794080e7          	jalr	1940(ra) # 5bfc <printf>
    exit(1);
    1470:	4505                	li	a0,1
    ...
    1480:	1cc50513          	addi	a0,a0,460 # 6648 <malloc+0x994>
    1484:	00004097          	auipc	ra,0x4
    1488:	778080e7          	jalr	1912(ra) # 5bfc <printf>
        exit(1);
    148c:	4505                	li	a0,1
    ...
    149e:	1d650513          	addi	a0,a0,470 # 6670 <malloc+0x9bc>
    14a2:	00004097          	auipc	ra,0x4
    14a6:	75a080e7          	jalr	1882(ra) # 5bfc <printf>
        exit(1);
    14aa:	4505                	li	a0,1
    ...
    14bc:	978a0a13          	addi	s4,s4,-1672 # 5e30 <malloc+0x17c>
    int n = write(fd, "xxx", 3);
    14c0:	00005a97          	auipc	s5,0x5
    14c4:	1d0a8a93          	addi	s5,s5,464 # 6690 <malloc+0x9dc>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    150e:	92650513          	addi	a0,a0,-1754 # 5e30 <malloc+0x17c>
  ...
  exit(xstatus);
    ...
    152c:	12050513          	addi	a0,a0,288 # 6648 <malloc+0x994>
    1530:	00004097          	auipc	ra,0x4
    1534:	6cc080e7          	jalr	1740(ra) # 5bfc <printf>
      exit(1);
    1538:	4505                	li	a0,1
    ...
    154a:	15250513          	addi	a0,a0,338 # 6698 <malloc+0x9e4>
    154e:	00004097          	auipc	ra,0x4
    1552:	6ae080e7          	jalr	1710(ra) # 5bfc <printf>
      exit(1);
    1556:	4505                	li	a0,1
...
0000000000001560 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1572:	86a78793          	addi	a5,a5,-1942 # 5dd8 <malloc+0x124>
    1576:	fcf43023          	sd	a5,-64(s0)
    157a:	00005797          	auipc	a5,0x5
    157e:	13e78793          	addi	a5,a5,318 # 66b8 <malloc+0xa04>
    1582:	fcf43423          	sd	a5,-56(s0)
    1586:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    158a:	00005517          	auipc	a0,0x5
    158e:	13650513          	addi	a0,a0,310 # 66c0 <malloc+0xa0c>
  ...
  if(pid == 0) {
    ...
    15bc:	10850513          	addi	a0,a0,264 # 66c0 <malloc+0xa0c>
    ...
    15d8:	10c50513          	addi	a0,a0,268 # 66e0 <malloc+0xa2c>
    15dc:	00004097          	auipc	ra,0x4
    15e0:	620080e7          	jalr	1568(ra) # 5bfc <printf>
      exit(1);
    15e4:	4505                	li	a0,1
    ...
    15f4:	04050513          	addi	a0,a0,64 # 6630 <malloc+0x97c>
    15f8:	00004097          	auipc	ra,0x4
    15fc:	604080e7          	jalr	1540(ra) # 5bfc <printf>
     exit(1);
    1600:	4505                	li	a0,1
    ...
    1610:	0bc50513          	addi	a0,a0,188 # 66c8 <malloc+0xa14>
    1614:	00004097          	auipc	ra,0x4
    1618:	5e8080e7          	jalr	1512(ra) # 5bfc <printf>
      exit(1);
    161c:	4505                	li	a0,1
    ...
    162e:	7ae50513          	addi	a0,a0,1966 # 5dd8 <malloc+0x124>
  ...
  if(xstatus != 0)
    ...
    1662:	09250513          	addi	a0,a0,146 # 66f0 <malloc+0xa3c>
    1666:	00004097          	auipc	ra,0x4
    166a:	596080e7          	jalr	1430(ra) # 5bfc <printf>
      exit(1);
    166e:	4505                	li	a0,1
    ...
    167e:	08e50513          	addi	a0,a0,142 # 6708 <malloc+0xa54>
    1682:	00004097          	auipc	ra,0x4
    1686:	57a080e7          	jalr	1402(ra) # 5bfc <printf>
    168a:	b7d1                	j	164e <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    168c:	4581                	li	a1,0
    168e:	00005517          	auipc	a0,0x5
    1692:	03250513          	addi	a0,a0,50 # 66c0 <malloc+0xa0c>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16bc:	ac050513          	addi	a0,a0,-1344 # 6178 <malloc+0x4c4>
    16c0:	00004097          	auipc	ra,0x4
    16c4:	53c080e7          	jalr	1340(ra) # 5bfc <printf>
    exit(1);
    16c8:	4505                	li	a0,1
    ...
    16d8:	f7450513          	addi	a0,a0,-140 # 6648 <malloc+0x994>
    16dc:	00004097          	auipc	ra,0x4
    16e0:	520080e7          	jalr	1312(ra) # 5bfc <printf>
    exit(1);
    16e4:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    16f2:	fd250513          	addi	a0,a0,-46 # 66c0 <malloc+0xa0c>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    171c:	00850513          	addi	a0,a0,8 # 6720 <malloc+0xa6c>
    1720:	00004097          	auipc	ra,0x4
    1724:	4dc080e7          	jalr	1244(ra) # 5bfc <printf>
    exit(1);
    1728:	4505                	li	a0,1
...
000000000000173c <pipe1>:
{
  ...
  if(pid == 0){
    ...
    1788:	694a8a93          	addi	s5,s5,1684 # be18 <buf>
      if(cc > sizeof(buf))
    ...
    17a6:	67670713          	addi	a4,a4,1654 # be18 <buf>
    ...
    17dc:	f6050513          	addi	a0,a0,-160 # 6738 <malloc+0xa84>
    17e0:	00004097          	auipc	ra,0x4
    17e4:	41c080e7          	jalr	1052(ra) # 5bfc <printf>
    exit(1);
    17e8:	4505                	li	a0,1
    ...
    1802:	61ab0b13          	addi	s6,s6,1562 # be18 <buf>
    ...
    1816:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x87>
{
    ...
    1862:	ef250513          	addi	a0,a0,-270 # 6750 <malloc+0xa9c>
    1866:	00004097          	auipc	ra,0x4
    186a:	396080e7          	jalr	918(ra) # 5bfc <printf>
        exit(1);
    186e:	4505                	li	a0,1
    ...
    187e:	eee50513          	addi	a0,a0,-274 # 6768 <malloc+0xab4>
    1882:	00004097          	auipc	ra,0x4
    1886:	37a080e7          	jalr	890(ra) # 5bfc <printf>
}
    ...
    18b0:	ed450513          	addi	a0,a0,-300 # 6780 <malloc+0xacc>
    18b4:	00004097          	auipc	ra,0x4
    18b8:	348080e7          	jalr	840(ra) # 5bfc <printf>
      exit(1);
    18bc:	4505                	li	a0,1
    ...
    18f0:	eb450513          	addi	a0,a0,-332 # 67a0 <malloc+0xaec>
    18f4:	00004097          	auipc	ra,0x4
    18f8:	308080e7          	jalr	776(ra) # 5bfc <printf>
    exit(1);
    18fc:	4505                	li	a0,1
...
0000000000001906 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1962:	cd250513          	addi	a0,a0,-814 # 6630 <malloc+0x97c>
    1966:	00004097          	auipc	ra,0x4
    196a:	296080e7          	jalr	662(ra) # 5bfc <printf>
      exit(1);
    196e:	4505                	li	a0,1
    ...
    197e:	e3e50513          	addi	a0,a0,-450 # 67b8 <malloc+0xb04>
    1982:	00004097          	auipc	ra,0x4
    1986:	27a080e7          	jalr	634(ra) # 5bfc <printf>
        exit(1);
    198a:	4505                	li	a0,1
    ...
    199a:	e3a50513          	addi	a0,a0,-454 # 67d0 <malloc+0xb1c>
    199e:	00004097          	auipc	ra,0x4
    19a2:	25e080e7          	jalr	606(ra) # 5bfc <printf>
        exit(1);
    19a6:	4505                	li	a0,1
...
00000000000019ba <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a12:	c2250513          	addi	a0,a0,-990 # 6630 <malloc+0x97c>
    1a16:	00004097          	auipc	ra,0x4
    1a1a:	1e6080e7          	jalr	486(ra) # 5bfc <printf>
      exit(1);
    1a1e:	4505                	li	a0,1
    ...
    1a36:	bfe50513          	addi	a0,a0,-1026 # 6630 <malloc+0x97c>
    1a3a:	00004097          	auipc	ra,0x4
    1a3e:	1c2080e7          	jalr	450(ra) # 5bfc <printf>
        exit(1);
    1a42:	4505                	li	a0,1
...
0000000000001a54 <forkfork>:
{
    ...
    1ab0:	d4450513          	addi	a0,a0,-700 # 67f0 <malloc+0xb3c>
    1ab4:	00004097          	auipc	ra,0x4
    1ab8:	148080e7          	jalr	328(ra) # 5bfc <printf>
      exit(1);
    1abc:	4505                	li	a0,1
    ...
    1ac2:	d84080e7          	jalr	-636(ra) # 5842 <exit>
{
    ...
    1b08:	cfc50513          	addi	a0,a0,-772 # 6800 <malloc+0xb4c>
    1b0c:	00004097          	auipc	ra,0x4
    1b10:	0f0080e7          	jalr	240(ra) # 5bfc <printf>
      exit(1);
    1b14:	4505                	li	a0,1
...
0000000000001b1e <reparent2>:
{
  ...
  exit(0);
    ...
    1b56:	efe50513          	addi	a0,a0,-258 # 6a50 <malloc+0xd9c>
    1b5a:	00004097          	auipc	ra,0x4
    1b5e:	0a2080e7          	jalr	162(ra) # 5bfc <printf>
      exit(1);
    1b62:	4505                	li	a0,1
...
0000000000001b86 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1bf4:	e6050513          	addi	a0,a0,-416 # 6a50 <malloc+0xd9c>
    1bf8:	00004097          	auipc	ra,0x4
    1bfc:	004080e7          	jalr	4(ra) # 5bfc <printf>
      exit(1);
    1c00:	4505                	li	a0,1
    ...
    1c20:	aac50513          	addi	a0,a0,-1364 # 66c8 <malloc+0xa14>
    1c24:	00004097          	auipc	ra,0x4
    1c28:	fd8080e7          	jalr	-40(ra) # 5bfc <printf>
          exit(1);
    1c2c:	4505                	li	a0,1
    ...
    1c92:	b9250513          	addi	a0,a0,-1134 # 6820 <malloc+0xb6c>
    1c96:	00004097          	auipc	ra,0x4
    1c9a:	f66080e7          	jalr	-154(ra) # 5bfc <printf>
            exit(1);
    1c9e:	4505                	li	a0,1
    ...
    1cc6:	b7650513          	addi	a0,a0,-1162 # 6838 <malloc+0xb84>
    1cca:	00004097          	auipc	ra,0x4
    1cce:	f32080e7          	jalr	-206(ra) # 5bfc <printf>
        exit(1);
    1cd2:	4505                	li	a0,1
    ...
    1d2c:	b3850513          	addi	a0,a0,-1224 # 6860 <malloc+0xbac>
    1d30:	00004097          	auipc	ra,0x4
    1d34:	ecc080e7          	jalr	-308(ra) # 5bfc <printf>
        exit(1);
    1d38:	4505                	li	a0,1
...
0000000000001dac <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dcc:	08050513          	addi	a0,a0,128 # 5e48 <malloc+0x194>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1df6:	e6d9899b          	addiw	s3,s3,-403 # 41c64e6d <__BSS_END__+0x41c56045>
    ...
    1e08:	044a8a93          	addi	s5,s5,68 # 5e48 <malloc+0x194>
      link("cat", "x");
    1e0c:	00005b97          	auipc	s7,0x5
    1e10:	a7cb8b93          	addi	s7,s7,-1412 # 6888 <malloc+0xbd4>
    1e14:	a825                	j	1e4c <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1e16:	85a6                	mv	a1,s1
    1e18:	00005517          	auipc	a0,0x5
    1e1c:	81850513          	addi	a0,a0,-2024 # 6630 <malloc+0x97c>
    1e20:	00004097          	auipc	ra,0x4
    1e24:	ddc080e7          	jalr	-548(ra) # 5bfc <printf>
    exit(1);
    1e28:	4505                	li	a0,1
...
0000000000001eae <manywrites>:
{
  ...
  exit(0);
    ...
    1f0a:	b4a50513          	addi	a0,a0,-1206 # 6a50 <malloc+0xd9c>
    1f0e:	00004097          	auipc	ra,0x4
    1f12:	cee080e7          	jalr	-786(ra) # 5bfc <printf>
      exit(1);
    1f16:	4505                	li	a0,1
    ...
    1f46:	ed6b0b13          	addi	s6,s6,-298 # be18 <buf>
    ...
    1fba:	8da50513          	addi	a0,a0,-1830 # 6890 <malloc+0xbdc>
    1fbe:	00004097          	auipc	ra,0x4
    1fc2:	c3e080e7          	jalr	-962(ra) # 5bfc <printf>
            exit(1);
    1fc6:	4505                	li	a0,1
    ...
    1fda:	ed250513          	addi	a0,a0,-302 # 5ea8 <malloc+0x1f4>
    1fde:	00004097          	auipc	ra,0x4
    1fe2:	c1e080e7          	jalr	-994(ra) # 5bfc <printf>
            exit(1);
    1fe6:	4505                	li	a0,1
...
0000000000001ff8 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    2028:	89c50513          	addi	a0,a0,-1892 # 68c0 <malloc+0xc0c>
    202c:	00004097          	auipc	ra,0x4
    2030:	bd0080e7          	jalr	-1072(ra) # 5bfc <printf>
    exit(1);
    2034:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    208a:	82250513          	addi	a0,a0,-2014 # 68a8 <malloc+0xbf4>
    208e:	00004097          	auipc	ra,0x4
    2092:	b6e080e7          	jalr	-1170(ra) # 5bfc <printf>
    exit(1);
    2096:	4505                	li	a0,1
    ...
    20a6:	84650513          	addi	a0,a0,-1978 # 68e8 <malloc+0xc34>
    20aa:	00004097          	auipc	ra,0x4
    20ae:	b52080e7          	jalr	-1198(ra) # 5bfc <printf>
      exit(1);
    20b2:	4505                	li	a0,1
    ...
    20c2:	84250513          	addi	a0,a0,-1982 # 6900 <malloc+0xc4c>
    20c6:	00004097          	auipc	ra,0x4
    20ca:	b36080e7          	jalr	-1226(ra) # 5bfc <printf>
    exit(1);
    20ce:	4505                	li	a0,1
...
00000000000020d8 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    20f4:	35098993          	addi	s3,s3,848 # c350 <buf+0x538>
    20f8:	1003d937          	lui	s2,0x1003d
    20fc:	090e                	slli	s2,s2,0x3
    20fe:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e658>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2142:	4f250513          	addi	a0,a0,1266 # 6630 <malloc+0x97c>
    2146:	00004097          	auipc	ra,0x4
    214a:	ab6080e7          	jalr	-1354(ra) # 5bfc <printf>
      exit(1);
    214e:	4505                	li	a0,1
    ...
    2164:	7b850513          	addi	a0,a0,1976 # 6918 <malloc+0xc64>
    2168:	00004097          	auipc	ra,0x4
    216c:	a94080e7          	jalr	-1388(ra) # 5bfc <printf>
      exit(1);
    2170:	4505                	li	a0,1
...
0000000000002184 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    21e6:	44e50513          	addi	a0,a0,1102 # 6630 <malloc+0x97c>
    21ea:	00004097          	auipc	ra,0x4
    21ee:	a12080e7          	jalr	-1518(ra) # 5bfc <printf>
      exit(1);
    21f2:	4505                	li	a0,1
    ...
    2212:	72a50513          	addi	a0,a0,1834 # 6938 <malloc+0xc84>
    2216:	00004097          	auipc	ra,0x4
    221a:	9e6080e7          	jalr	-1562(ra) # 5bfc <printf>
      exit(1);
    221e:	4505                	li	a0,1
...
0000000000002232 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2242:	71250513          	addi	a0,a0,1810 # 6950 <malloc+0xc9c>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2274:	6e050513          	addi	a0,a0,1760 # 6950 <malloc+0xc9c>
  ...
  close(fd);
    ...
    229a:	36a78793          	addi	a5,a5,874 # 8600 <args.1>
    229e:	00006697          	auipc	a3,0x6
    22a2:	45a68693          	addi	a3,a3,1114 # 86f8 <args.1+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    22a6:	00004717          	auipc	a4,0x4
    22aa:	6ba70713          	addi	a4,a4,1722 # 6960 <malloc+0xcac>
    ...
    22fe:	74650513          	addi	a0,a0,1862 # 6a40 <malloc+0xd8c>
    2302:	00004097          	auipc	ra,0x4
    2306:	8fa080e7          	jalr	-1798(ra) # 5bfc <printf>
    exit(1);
    230a:	4505                	li	a0,1
    ...
    2322:	74250513          	addi	a0,a0,1858 # 6a60 <malloc+0xdac>
    2326:	00004097          	auipc	ra,0x4
    232a:	8d6080e7          	jalr	-1834(ra) # 5bfc <printf>
    exit(1);
    232e:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2376:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff01d8>
    237a:	85a6                	mv	a1,s1
    237c:	00004517          	auipc	a0,0x4
    2380:	70450513          	addi	a0,a0,1796 # 6a80 <malloc+0xdcc>
    2384:	00004097          	auipc	ra,0x4
    2388:	878080e7          	jalr	-1928(ra) # 5bfc <printf>
    exit(1);
    238c:	4505                	li	a0,1
    ...
    239c:	29850513          	addi	a0,a0,664 # 6630 <malloc+0x97c>
    23a0:	00004097          	auipc	ra,0x4
    23a4:	85c080e7          	jalr	-1956(ra) # 5bfc <printf>
    exit(1);
    23a8:	4505                	li	a0,1
...
00000000000023bc <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2436:	2f678793          	addi	a5,a5,758 # 7728 <malloc+0x1a74>
  ...
  if(ret != -1){
    ...
    2478:	63450513          	addi	a0,a0,1588 # 6aa8 <malloc+0xdf4>
    247c:	00003097          	auipc	ra,0x3
    2480:	780080e7          	jalr	1920(ra) # 5bfc <printf>
    exit(1);
    2484:	4505                	li	a0,1
    ...
    2496:	0be50513          	addi	a0,a0,190 # 6550 <malloc+0x89c>
    249a:	00003097          	auipc	ra,0x3
    249e:	762080e7          	jalr	1890(ra) # 5bfc <printf>
    exit(1);
    24a2:	4505                	li	a0,1
    ...
    24b4:	0c050513          	addi	a0,a0,192 # 6570 <malloc+0x8bc>
    24b8:	00003097          	auipc	ra,0x3
    24bc:	744080e7          	jalr	1860(ra) # 5bfc <printf>
    exit(1);
    24c0:	4505                	li	a0,1
    ...
    24d4:	0c050513          	addi	a0,a0,192 # 6590 <malloc+0x8dc>
    24d8:	00003097          	auipc	ra,0x3
    24dc:	724080e7          	jalr	1828(ra) # 5bfc <printf>
    exit(1);
    24e0:	4505                	li	a0,1
    ...
    24f2:	0ca50513          	addi	a0,a0,202 # 65b8 <malloc+0x904>
    24f6:	00003097          	auipc	ra,0x3
    24fa:	706080e7          	jalr	1798(ra) # 5bfc <printf>
    exit(1);
    24fe:	4505                	li	a0,1
...
0000000000002508 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    253e:	5ae50513          	addi	a0,a0,1454 # 6ae8 <malloc+0xe34>
  ...
  if(n >= 0){
    ...
    256e:	59e50513          	addi	a0,a0,1438 # 6b08 <malloc+0xe54>
    2572:	00003097          	auipc	ra,0x3
    2576:	68a080e7          	jalr	1674(ra) # 5bfc <printf>
    exit(1);
    257a:	4505                	li	a0,1
    ...
    2588:	52c50513          	addi	a0,a0,1324 # 6ab0 <malloc+0xdfc>
    258c:	00003097          	auipc	ra,0x3
    2590:	670080e7          	jalr	1648(ra) # 5bfc <printf>
    exit(1);
    2594:	4505                	li	a0,1
    ...
    25a2:	52a50513          	addi	a0,a0,1322 # 6ac8 <malloc+0xe14>
    25a6:	00003097          	auipc	ra,0x3
    25aa:	656080e7          	jalr	1622(ra) # 5bfc <printf>
    exit(1);
    25ae:	4505                	li	a0,1
    ...
    25bc:	53850513          	addi	a0,a0,1336 # 6af0 <malloc+0xe3c>
    25c0:	00003097          	auipc	ra,0x3
    25c4:	63c080e7          	jalr	1596(ra) # 5bfc <printf>
    exit(1);
    25c8:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    25e0:	50c50513          	addi	a0,a0,1292 # 6ae8 <malloc+0xe34>
    25e4:	00003097          	auipc	ra,0x3
    25e8:	2ae080e7          	jalr	686(ra) # 5892 <unlink>
  fd = open("README", O_RDONLY);
    25ec:	4581                	li	a1,0
    25ee:	00004517          	auipc	a0,0x4
    25f2:	99250513          	addi	a0,a0,-1646 # 5f80 <malloc+0x2cc>
  ...
  if(n >= 0){
    ...
    261c:	52050513          	addi	a0,a0,1312 # 6b38 <malloc+0xe84>
    2620:	00003097          	auipc	ra,0x3
    2624:	5dc080e7          	jalr	1500(ra) # 5bfc <printf>
    exit(1);
    2628:	4505                	li	a0,1
    ...
    2636:	4be50513          	addi	a0,a0,1214 # 6af0 <malloc+0xe3c>
    263a:	00003097          	auipc	ra,0x3
    263e:	5c2080e7          	jalr	1474(ra) # 5bfc <printf>
    exit(1);
    2642:	4505                	li	a0,1
...
0000000000002660 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    269c:	6705                	lui	a4,0x1
      *b = 99;
    269e:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff11d8>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    26b6:	4ae50513          	addi	a0,a0,1198 # 6b60 <malloc+0xeac>
    26ba:	00003097          	auipc	ra,0x3
    26be:	542080e7          	jalr	1346(ra) # 5bfc <printf>
    exit(1);
    26c2:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2708:	47c50513          	addi	a0,a0,1148 # 6b80 <malloc+0xecc>
    270c:	00003097          	auipc	ra,0x3
    2710:	4f0080e7          	jalr	1264(ra) # 5bfc <printf>
    exit(1);
    2714:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    276c:	47850513          	addi	a0,a0,1144 # 6be0 <malloc+0xf2c>
    2770:	00003097          	auipc	ra,0x3
    2774:	48c080e7          	jalr	1164(ra) # 5bfc <printf>
    exit(1);
    2778:	4505                	li	a0,1
    ...
    278e:	41650513          	addi	a0,a0,1046 # 6ba0 <malloc+0xeec>
    2792:	00003097          	auipc	ra,0x3
    2796:	46a080e7          	jalr	1130(ra) # 5bfc <printf>
      exit(1);
    279a:	4505                	li	a0,1
    ...
    27aa:	41a50513          	addi	a0,a0,1050 # 6bc0 <malloc+0xf0c>
    27ae:	00003097          	auipc	ra,0x3
    27b2:	44e080e7          	jalr	1102(ra) # 5bfc <printf>
    exit(1);
    27b6:	4505                	li	a0,1
...
00000000000027e6 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    2848:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f11d7>
  a = sbrk(0);
    284c:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    28ac:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f11d7>
  ...
  if(c != a){
    ...
    28f4:	31050513          	addi	a0,a0,784 # 6c00 <malloc+0xf4c>
    28f8:	00003097          	auipc	ra,0x3
    28fc:	304080e7          	jalr	772(ra) # 5bfc <printf>
    exit(1);
    2900:	4505                	li	a0,1
    ...
    2910:	33c50513          	addi	a0,a0,828 # 6c48 <malloc+0xf94>
    2914:	00003097          	auipc	ra,0x3
    2918:	2e8080e7          	jalr	744(ra) # 5bfc <printf>
    exit(1);
    291c:	4505                	li	a0,1
    ...
    2930:	33c50513          	addi	a0,a0,828 # 6c68 <malloc+0xfb4>
    2934:	00003097          	auipc	ra,0x3
    2938:	2c8080e7          	jalr	712(ra) # 5bfc <printf>
    exit(1);
    293c:	4505                	li	a0,1
    ...
    2950:	35c50513          	addi	a0,a0,860 # 6ca8 <malloc+0xff4>
    2954:	00003097          	auipc	ra,0x3
    2958:	2a8080e7          	jalr	680(ra) # 5bfc <printf>
    exit(1);
    295c:	4505                	li	a0,1
    ...
    296c:	37050513          	addi	a0,a0,880 # 6cd8 <malloc+0x1024>
    2970:	00003097          	auipc	ra,0x3
    2974:	28c080e7          	jalr	652(ra) # 5bfc <printf>
    exit(1);
    2978:	4505                	li	a0,1
    ...
    298c:	38850513          	addi	a0,a0,904 # 6d10 <malloc+0x105c>
    2990:	00003097          	auipc	ra,0x3
    2994:	26c080e7          	jalr	620(ra) # 5bfc <printf>
    exit(1);
    2998:	4505                	li	a0,1
...
00000000000029a2 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    29c6:	37650513          	addi	a0,a0,886 # 6d38 <malloc+0x1084>
    29ca:	00003097          	auipc	ra,0x3
    29ce:	eb8080e7          	jalr	-328(ra) # 5882 <open>
    29d2:	84aa                	mv	s1,a0
  unlink("sbrk");
    29d4:	00004517          	auipc	a0,0x4
    29d8:	36450513          	addi	a0,a0,868 # 6d38 <malloc+0x1084>
  ...
  if(pipe((int *) a) != 0){
    ...
    2a2c:	31850513          	addi	a0,a0,792 # 6d40 <malloc+0x108c>
    2a30:	00003097          	auipc	ra,0x3
    2a34:	1cc080e7          	jalr	460(ra) # 5bfc <printf>
    exit(1);
    2a38:	4505                	li	a0,1
    ...
    2a48:	31450513          	addi	a0,a0,788 # 6d58 <malloc+0x10a4>
    2a4c:	00003097          	auipc	ra,0x3
    2a50:	1b0080e7          	jalr	432(ra) # 5bfc <printf>
    exit(1);
    2a54:	4505                	li	a0,1
    ...
    2a64:	cd850513          	addi	a0,a0,-808 # 6738 <malloc+0xa84>
    2a68:	00003097          	auipc	ra,0x3
    2a6c:	194080e7          	jalr	404(ra) # 5bfc <printf>
    exit(1);
    2a70:	4505                	li	a0,1
...
0000000000002a7a <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2a8e:	2e650513          	addi	a0,a0,742 # 6d70 <malloc+0x10bc>
  ...
  close(fd);
    ...
    2ad6:	b7650513          	addi	a0,a0,-1162 # 6648 <malloc+0x994>
    2ada:	00003097          	auipc	ra,0x3
    2ade:	122080e7          	jalr	290(ra) # 5bfc <printf>
    exit(1);
    2ae2:	4505                	li	a0,1
...
0000000000002aec <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2b24:	f3050513          	addi	a0,a0,-208 # 6a50 <malloc+0xd9c>
    2b28:	00003097          	auipc	ra,0x3
    2b2c:	0d4080e7          	jalr	212(ra) # 5bfc <printf>
    exit(1);
    2b30:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2b7a:	eda50513          	addi	a0,a0,-294 # 6a50 <malloc+0xd9c>
    2b7e:	00003097          	auipc	ra,0x3
    2b82:	07e080e7          	jalr	126(ra) # 5bfc <printf>
    exit(1);
    2b86:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2bb2:	8007879b          	addiw	a5,a5,-2048 # a800 <uninit+0x10f8>
    ...
    2bda:	e7a50513          	addi	a0,a0,-390 # 6a50 <malloc+0xd9c>
    2bde:	00003097          	auipc	ra,0x3
    2be2:	01e080e7          	jalr	30(ra) # 5bfc <printf>
    exit(1);
    2be6:	4505                	li	a0,1
...
0000000000002cd6 <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    2ce2:	0511                	addi	a0,a0,4 # ffffffff80000004 <__BSS_END__+0xffffffff7fff11dc>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2d4e:	d0650513          	addi	a0,a0,-762 # 6a50 <malloc+0xd9c>
    2d52:	00003097          	auipc	ra,0x3
    2d56:	eaa080e7          	jalr	-342(ra) # 5bfc <printf>
      exit(1);
    2d5a:	4505                	li	a0,1
    ...
    2da2:	03a50513          	addi	a0,a0,58 # 5dd8 <malloc+0x124>
    2da6:	faa43c23          	sd	a0,-72(s0)
    2daa:	00003797          	auipc	a5,0x3
    2dae:	09e78793          	addi	a5,a5,158 # 5e48 <malloc+0x194>
...
0000000000002dd0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2de0:	16c50513          	addi	a0,a0,364 # 6f48 <malloc+0x1294>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2df2:	fb250513          	addi	a0,a0,-78 # 6da0 <malloc+0x10ec>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2e08:	ff450513          	addi	a0,a0,-12 # 6df8 <malloc+0x1144>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2e26:	04e50513          	addi	a0,a0,78 # 6e70 <malloc+0x11bc>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2e42:	0a250513          	addi	a0,a0,162 # 6ee0 <malloc+0x122c>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2e54:	0e850513          	addi	a0,a0,232 # 6f38 <malloc+0x1284>
  ...
  unlink("12345678901234");
    ...
    2ed2:	eaa50513          	addi	a0,a0,-342 # 6d78 <malloc+0x10c4>
    2ed6:	00003097          	auipc	ra,0x3
    2eda:	d26080e7          	jalr	-730(ra) # 5bfc <printf>
    exit(1);
    2ede:	4505                	li	a0,1
    ...
    2eee:	ed650513          	addi	a0,a0,-298 # 6dc0 <malloc+0x110c>
    2ef2:	00003097          	auipc	ra,0x3
    2ef6:	d0a080e7          	jalr	-758(ra) # 5bfc <printf>
    exit(1);
    2efa:	4505                	li	a0,1
    ...
    2f0a:	f2250513          	addi	a0,a0,-222 # 6e28 <malloc+0x1174>
    2f0e:	00003097          	auipc	ra,0x3
    2f12:	cee080e7          	jalr	-786(ra) # 5bfc <printf>
    exit(1);
    2f16:	4505                	li	a0,1
    ...
    2f26:	f7e50513          	addi	a0,a0,-130 # 6ea0 <malloc+0x11ec>
    2f2a:	00003097          	auipc	ra,0x3
    2f2e:	cd2080e7          	jalr	-814(ra) # 5bfc <printf>
    exit(1);
    2f32:	4505                	li	a0,1
    ...
    2f42:	fc250513          	addi	a0,a0,-62 # 6f00 <malloc+0x124c>
    2f46:	00003097          	auipc	ra,0x3
    2f4a:	cb6080e7          	jalr	-842(ra) # 5bfc <printf>
    exit(1);
    2f4e:	4505                	li	a0,1
    ...
    2f5e:	ffe50513          	addi	a0,a0,-2 # 6f58 <malloc+0x12a4>
    2f62:	00003097          	auipc	ra,0x3
    2f66:	c9a080e7          	jalr	-870(ra) # 5bfc <printf>
    exit(1);
    2f6a:	4505                	li	a0,1
...
0000000000002f74 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2f84:	01050513          	addi	a0,a0,16 # 6f90 <malloc+0x12dc>
  ...
  if(chdir("iputdir") < 0){
    ...
    2f98:	ffc50513          	addi	a0,a0,-4 # 6f90 <malloc+0x12dc>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2fac:	02850513          	addi	a0,a0,40 # 6fd0 <malloc+0x131c>
  ...
  if(chdir("/") < 0){
    ...
    2fc0:	04450513          	addi	a0,a0,68 # 7000 <malloc+0x134c>
    ...
    2fe0:	fbc50513          	addi	a0,a0,-68 # 6f98 <malloc+0x12e4>
    2fe4:	00003097          	auipc	ra,0x3
    2fe8:	c18080e7          	jalr	-1000(ra) # 5bfc <printf>
    exit(1);
    2fec:	4505                	li	a0,1
    ...
    2ffc:	fb850513          	addi	a0,a0,-72 # 6fb0 <malloc+0x12fc>
    3000:	00003097          	auipc	ra,0x3
    3004:	bfc080e7          	jalr	-1028(ra) # 5bfc <printf>
    exit(1);
    3008:	4505                	li	a0,1
    ...
    3018:	fcc50513          	addi	a0,a0,-52 # 6fe0 <malloc+0x132c>
    301c:	00003097          	auipc	ra,0x3
    3020:	be0080e7          	jalr	-1056(ra) # 5bfc <printf>
    exit(1);
    3024:	4505                	li	a0,1
    ...
    3034:	fd850513          	addi	a0,a0,-40 # 7008 <malloc+0x1354>
    3038:	00003097          	auipc	ra,0x3
    303c:	bc4080e7          	jalr	-1084(ra) # 5bfc <printf>
    exit(1);
    3040:	4505                	li	a0,1
...
000000000000304a <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    3068:	f2c50513          	addi	a0,a0,-212 # 6f90 <malloc+0x12dc>
    ...
    307c:	f1850513          	addi	a0,a0,-232 # 6f90 <malloc+0x12dc>
    ...
    3090:	f4450513          	addi	a0,a0,-188 # 6fd0 <malloc+0x131c>
    ...
    30b0:	58450513          	addi	a0,a0,1412 # 6630 <malloc+0x97c>
    30b4:	00003097          	auipc	ra,0x3
    30b8:	b48080e7          	jalr	-1208(ra) # 5bfc <printf>
    exit(1);
    30bc:	4505                	li	a0,1
    ...
    30cc:	ed050513          	addi	a0,a0,-304 # 6f98 <malloc+0x12e4>
    30d0:	00003097          	auipc	ra,0x3
    30d4:	b2c080e7          	jalr	-1236(ra) # 5bfc <printf>
      exit(1);
    30d8:	4505                	li	a0,1
    ...
    30e8:	f3c50513          	addi	a0,a0,-196 # 7020 <malloc+0x136c>
    30ec:	00003097          	auipc	ra,0x3
    30f0:	b10080e7          	jalr	-1264(ra) # 5bfc <printf>
      exit(1);
    30f4:	4505                	li	a0,1
    ...
    3104:	ee050513          	addi	a0,a0,-288 # 6fe0 <malloc+0x132c>
    3108:	00003097          	auipc	ra,0x3
    310c:	af4080e7          	jalr	-1292(ra) # 5bfc <printf>
      exit(1);
    3110:	4505                	li	a0,1
...
0000000000003132 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    3142:	efa50513          	addi	a0,a0,-262 # 7038 <malloc+0x1384>
  ...
  if(chdir("dir0") < 0){
    ...
    3156:	ee650513          	addi	a0,a0,-282 # 7038 <malloc+0x1384>
  ...
  if(chdir("..") < 0){
    ...
    316a:	ef250513          	addi	a0,a0,-270 # 7058 <malloc+0x13a4>
  ...
  if(unlink("dir0") < 0){
    ...
    317e:	ebe50513          	addi	a0,a0,-322 # 7038 <malloc+0x1384>
    ...
    319e:	dfe50513          	addi	a0,a0,-514 # 6f98 <malloc+0x12e4>
    31a2:	00003097          	auipc	ra,0x3
    31a6:	a5a080e7          	jalr	-1446(ra) # 5bfc <printf>
    exit(1);
    31aa:	4505                	li	a0,1
    ...
    31ba:	e8a50513          	addi	a0,a0,-374 # 7040 <malloc+0x138c>
    31be:	00003097          	auipc	ra,0x3
    31c2:	a3e080e7          	jalr	-1474(ra) # 5bfc <printf>
    exit(1);
    31c6:	4505                	li	a0,1
    ...
    31d6:	e8e50513          	addi	a0,a0,-370 # 7060 <malloc+0x13ac>
    31da:	00003097          	auipc	ra,0x3
    31de:	a22080e7          	jalr	-1502(ra) # 5bfc <printf>
    exit(1);
    31e2:	4505                	li	a0,1
    ...
    31f2:	e8a50513          	addi	a0,a0,-374 # 7078 <malloc+0x13c4>
    31f6:	00003097          	auipc	ra,0x3
    31fa:	a06080e7          	jalr	-1530(ra) # 5bfc <printf>
    exit(1);
    31fe:	4505                	li	a0,1
...
0000000000003208 <subdir>:
{
  ...
  unlink("ff");
    ...
    321a:	faa50513          	addi	a0,a0,-86 # 71c0 <malloc+0x150c>
    321e:	00002097          	auipc	ra,0x2
    3222:	674080e7          	jalr	1652(ra) # 5892 <unlink>
  if(mkdir("dd") != 0){
    3226:	00004517          	auipc	a0,0x4
    322a:	e6a50513          	addi	a0,a0,-406 # 7090 <malloc+0x13dc>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3242:	e7250513          	addi	a0,a0,-398 # 70b0 <malloc+0x13fc>
  ...
  write(fd, "ff", 2);
    ...
    325a:	f6a58593          	addi	a1,a1,-150 # 71c0 <malloc+0x150c>
  ...
  if(unlink("dd") >= 0){
    ...
    3274:	e2050513          	addi	a0,a0,-480 # 7090 <malloc+0x13dc>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3288:	e8450513          	addi	a0,a0,-380 # 7108 <malloc+0x1454>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    32a0:	e9450513          	addi	a0,a0,-364 # 7130 <malloc+0x147c>
  ...
  write(fd, "FF", 2);
    ...
    32b8:	eac58593          	addi	a1,a1,-340 # 7160 <malloc+0x14ac>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    32d4:	e9850513          	addi	a0,a0,-360 # 7168 <malloc+0x14b4>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    32ec:	b3058593          	addi	a1,a1,-1232 # be18 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3302:	b1a74703          	lbu	a4,-1254(a4) # be18 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    331c:	ea058593          	addi	a1,a1,-352 # 71b8 <malloc+0x1504>
    3320:	00004517          	auipc	a0,0x4
    3324:	e1050513          	addi	a0,a0,-496 # 7130 <malloc+0x147c>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3338:	dfc50513          	addi	a0,a0,-516 # 7130 <malloc+0x147c>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    334e:	de650513          	addi	a0,a0,-538 # 7130 <malloc+0x147c>
  ...
  if(chdir("dd") != 0){
    ...
    3362:	d3250513          	addi	a0,a0,-718 # 7090 <malloc+0x13dc>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3376:	ede50513          	addi	a0,a0,-290 # 7250 <malloc+0x159c>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    338a:	efa50513          	addi	a0,a0,-262 # 7280 <malloc+0x15cc>
  ...
  if(chdir("./..") != 0){
    ...
    339e:	f1650513          	addi	a0,a0,-234 # 72b0 <malloc+0x15fc>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    33b4:	e0850513          	addi	a0,a0,-504 # 71b8 <malloc+0x1504>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    33cc:	a5058593          	addi	a1,a1,-1456 # be18 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    33ee:	d4650513          	addi	a0,a0,-698 # 7130 <malloc+0x147c>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3406:	f3e50513          	addi	a0,a0,-194 # 7340 <malloc+0x168c>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    341e:	f5650513          	addi	a0,a0,-170 # 7370 <malloc+0x16bc>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3436:	c5e50513          	addi	a0,a0,-930 # 7090 <malloc+0x13dc>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    344c:	c4850513          	addi	a0,a0,-952 # 7090 <malloc+0x13dc>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    3462:	c3250513          	addi	a0,a0,-974 # 7090 <malloc+0x13dc>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3476:	f8e58593          	addi	a1,a1,-114 # 7400 <malloc+0x174c>
    347a:	00004517          	auipc	a0,0x4
    347e:	ec650513          	addi	a0,a0,-314 # 7340 <malloc+0x168c>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3492:	f7258593          	addi	a1,a1,-142 # 7400 <malloc+0x174c>
    3496:	00004517          	auipc	a0,0x4
    349a:	eda50513          	addi	a0,a0,-294 # 7370 <malloc+0x16bc>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    34ae:	d0e58593          	addi	a1,a1,-754 # 71b8 <malloc+0x1504>
    34b2:	00004517          	auipc	a0,0x4
    34b6:	bfe50513          	addi	a0,a0,-1026 # 70b0 <malloc+0x13fc>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    34ca:	e7a50513          	addi	a0,a0,-390 # 7340 <malloc+0x168c>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    34de:	e9650513          	addi	a0,a0,-362 # 7370 <malloc+0x16bc>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    34f2:	cca50513          	addi	a0,a0,-822 # 71b8 <malloc+0x1504>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3506:	e6e50513          	addi	a0,a0,-402 # 7370 <malloc+0x16bc>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    351a:	e2a50513          	addi	a0,a0,-470 # 7340 <malloc+0x168c>
  ...
  if(chdir("dd/ff") == 0){
    ...
    352e:	b8650513          	addi	a0,a0,-1146 # 70b0 <malloc+0x13fc>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3542:	01250513          	addi	a0,a0,18 # 7550 <malloc+0x189c>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3556:	c6650513          	addi	a0,a0,-922 # 71b8 <malloc+0x1504>
  ...
  if(unlink("dd/ff") != 0){
    ...
    356a:	b4a50513          	addi	a0,a0,-1206 # 70b0 <malloc+0x13fc>
  ...
  if(unlink("dd") == 0){
    ...
    357e:	b1650513          	addi	a0,a0,-1258 # 7090 <malloc+0x13dc>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3592:	03250513          	addi	a0,a0,50 # 75c0 <malloc+0x190c>
  ...
  if(unlink("dd") < 0){
    ...
    35a6:	aee50513          	addi	a0,a0,-1298 # 7090 <malloc+0x13dc>
    ...
    35c8:	ad450513          	addi	a0,a0,-1324 # 7098 <malloc+0x13e4>
    35cc:	00002097          	auipc	ra,0x2
    35d0:	630080e7          	jalr	1584(ra) # 5bfc <printf>
    exit(1);
    35d4:	4505                	li	a0,1
    ...
    35e4:	ad850513          	addi	a0,a0,-1320 # 70b8 <malloc+0x1404>
    35e8:	00002097          	auipc	ra,0x2
    35ec:	614080e7          	jalr	1556(ra) # 5bfc <printf>
    exit(1);
    35f0:	4505                	li	a0,1
    ...
    3600:	adc50513          	addi	a0,a0,-1316 # 70d8 <malloc+0x1424>
    3604:	00002097          	auipc	ra,0x2
    3608:	5f8080e7          	jalr	1528(ra) # 5bfc <printf>
    exit(1);
    360c:	4505                	li	a0,1
    ...
    361c:	af850513          	addi	a0,a0,-1288 # 7110 <malloc+0x145c>
    3620:	00002097          	auipc	ra,0x2
    3624:	5dc080e7          	jalr	1500(ra) # 5bfc <printf>
    exit(1);
    3628:	4505                	li	a0,1
    ...
    3638:	b0c50513          	addi	a0,a0,-1268 # 7140 <malloc+0x148c>
    363c:	00002097          	auipc	ra,0x2
    3640:	5c0080e7          	jalr	1472(ra) # 5bfc <printf>
    exit(1);
    3644:	4505                	li	a0,1
    ...
    3654:	b2850513          	addi	a0,a0,-1240 # 7178 <malloc+0x14c4>
    3658:	00002097          	auipc	ra,0x2
    365c:	5a4080e7          	jalr	1444(ra) # 5bfc <printf>
    exit(1);
    3660:	4505                	li	a0,1
    ...
    3670:	b2c50513          	addi	a0,a0,-1236 # 7198 <malloc+0x14e4>
    3674:	00002097          	auipc	ra,0x2
    3678:	588080e7          	jalr	1416(ra) # 5bfc <printf>
    exit(1);
    367c:	4505                	li	a0,1
    ...
    368c:	b4050513          	addi	a0,a0,-1216 # 71c8 <malloc+0x1514>
    3690:	00002097          	auipc	ra,0x2
    3694:	56c080e7          	jalr	1388(ra) # 5bfc <printf>
    exit(1);
    3698:	4505                	li	a0,1
    ...
    36a8:	b4c50513          	addi	a0,a0,-1204 # 71f0 <malloc+0x153c>
    36ac:	00002097          	auipc	ra,0x2
    36b0:	550080e7          	jalr	1360(ra) # 5bfc <printf>
    exit(1);
    36b4:	4505                	li	a0,1
    ...
    36c4:	b5050513          	addi	a0,a0,-1200 # 7210 <malloc+0x155c>
    36c8:	00002097          	auipc	ra,0x2
    36cc:	534080e7          	jalr	1332(ra) # 5bfc <printf>
    exit(1);
    36d0:	4505                	li	a0,1
    ...
    36e0:	b5c50513          	addi	a0,a0,-1188 # 7238 <malloc+0x1584>
    36e4:	00002097          	auipc	ra,0x2
    36e8:	518080e7          	jalr	1304(ra) # 5bfc <printf>
    exit(1);
    36ec:	4505                	li	a0,1
    ...
    36fc:	b6850513          	addi	a0,a0,-1176 # 7260 <malloc+0x15ac>
    3700:	00002097          	auipc	ra,0x2
    3704:	4fc080e7          	jalr	1276(ra) # 5bfc <printf>
    exit(1);
    3708:	4505                	li	a0,1
    ...
    3718:	b7c50513          	addi	a0,a0,-1156 # 7290 <malloc+0x15dc>
    371c:	00002097          	auipc	ra,0x2
    3720:	4e0080e7          	jalr	1248(ra) # 5bfc <printf>
    exit(1);
    3724:	4505                	li	a0,1
    ...
    3734:	b8850513          	addi	a0,a0,-1144 # 72b8 <malloc+0x1604>
    3738:	00002097          	auipc	ra,0x2
    373c:	4c4080e7          	jalr	1220(ra) # 5bfc <printf>
    exit(1);
    3740:	4505                	li	a0,1
    ...
    3750:	b8450513          	addi	a0,a0,-1148 # 72d0 <malloc+0x161c>
    3754:	00002097          	auipc	ra,0x2
    3758:	4a8080e7          	jalr	1192(ra) # 5bfc <printf>
    exit(1);
    375c:	4505                	li	a0,1
    ...
    376c:	b8850513          	addi	a0,a0,-1144 # 72f0 <malloc+0x163c>
    3770:	00002097          	auipc	ra,0x2
    3774:	48c080e7          	jalr	1164(ra) # 5bfc <printf>
    exit(1);
    3778:	4505                	li	a0,1
    ...
    3788:	b8c50513          	addi	a0,a0,-1140 # 7310 <malloc+0x165c>
    378c:	00002097          	auipc	ra,0x2
    3790:	470080e7          	jalr	1136(ra) # 5bfc <printf>
    exit(1);
    3794:	4505                	li	a0,1
    ...
    37a4:	bb050513          	addi	a0,a0,-1104 # 7350 <malloc+0x169c>
    37a8:	00002097          	auipc	ra,0x2
    37ac:	454080e7          	jalr	1108(ra) # 5bfc <printf>
    exit(1);
    37b0:	4505                	li	a0,1
    ...
    37c0:	bc450513          	addi	a0,a0,-1084 # 7380 <malloc+0x16cc>
    37c4:	00002097          	auipc	ra,0x2
    37c8:	438080e7          	jalr	1080(ra) # 5bfc <printf>
    exit(1);
    37cc:	4505                	li	a0,1
    ...
    37dc:	bc850513          	addi	a0,a0,-1080 # 73a0 <malloc+0x16ec>
    37e0:	00002097          	auipc	ra,0x2
    37e4:	41c080e7          	jalr	1052(ra) # 5bfc <printf>
    exit(1);
    37e8:	4505                	li	a0,1
    ...
    37f8:	bcc50513          	addi	a0,a0,-1076 # 73c0 <malloc+0x170c>
    37fc:	00002097          	auipc	ra,0x2
    3800:	400080e7          	jalr	1024(ra) # 5bfc <printf>
    exit(1);
    3804:	4505                	li	a0,1
    ...
    3814:	bd050513          	addi	a0,a0,-1072 # 73e0 <malloc+0x172c>
    3818:	00002097          	auipc	ra,0x2
    381c:	3e4080e7          	jalr	996(ra) # 5bfc <printf>
    exit(1);
    3820:	4505                	li	a0,1
    ...
    3830:	be450513          	addi	a0,a0,-1052 # 7410 <malloc+0x175c>
    3834:	00002097          	auipc	ra,0x2
    3838:	3c8080e7          	jalr	968(ra) # 5bfc <printf>
    exit(1);
    383c:	4505                	li	a0,1
    ...
    384c:	bf050513          	addi	a0,a0,-1040 # 7438 <malloc+0x1784>
    3850:	00002097          	auipc	ra,0x2
    3854:	3ac080e7          	jalr	940(ra) # 5bfc <printf>
    exit(1);
    3858:	4505                	li	a0,1
    ...
    3868:	bfc50513          	addi	a0,a0,-1028 # 7460 <malloc+0x17ac>
    386c:	00002097          	auipc	ra,0x2
    3870:	390080e7          	jalr	912(ra) # 5bfc <printf>
    exit(1);
    3874:	4505                	li	a0,1
    ...
    3884:	c0850513          	addi	a0,a0,-1016 # 7488 <malloc+0x17d4>
    3888:	00002097          	auipc	ra,0x2
    388c:	374080e7          	jalr	884(ra) # 5bfc <printf>
    exit(1);
    3890:	4505                	li	a0,1
    ...
    38a0:	c0c50513          	addi	a0,a0,-1012 # 74a8 <malloc+0x17f4>
    38a4:	00002097          	auipc	ra,0x2
    38a8:	358080e7          	jalr	856(ra) # 5bfc <printf>
    exit(1);
    38ac:	4505                	li	a0,1
    ...
    38bc:	c1050513          	addi	a0,a0,-1008 # 74c8 <malloc+0x1814>
    38c0:	00002097          	auipc	ra,0x2
    38c4:	33c080e7          	jalr	828(ra) # 5bfc <printf>
    exit(1);
    38c8:	4505                	li	a0,1
    ...
    38d8:	c1c50513          	addi	a0,a0,-996 # 74f0 <malloc+0x183c>
    38dc:	00002097          	auipc	ra,0x2
    38e0:	320080e7          	jalr	800(ra) # 5bfc <printf>
    exit(1);
    38e4:	4505                	li	a0,1
    ...
    38f4:	c2050513          	addi	a0,a0,-992 # 7510 <malloc+0x185c>
    38f8:	00002097          	auipc	ra,0x2
    38fc:	304080e7          	jalr	772(ra) # 5bfc <printf>
    exit(1);
    3900:	4505                	li	a0,1
    ...
    3910:	c2450513          	addi	a0,a0,-988 # 7530 <malloc+0x187c>
    3914:	00002097          	auipc	ra,0x2
    3918:	2e8080e7          	jalr	744(ra) # 5bfc <printf>
    exit(1);
    391c:	4505                	li	a0,1
    ...
    392c:	c3050513          	addi	a0,a0,-976 # 7558 <malloc+0x18a4>
    3930:	00002097          	auipc	ra,0x2
    3934:	2cc080e7          	jalr	716(ra) # 5bfc <printf>
    exit(1);
    3938:	4505                	li	a0,1
    ...
    3948:	8ac50513          	addi	a0,a0,-1876 # 71f0 <malloc+0x153c>
    394c:	00002097          	auipc	ra,0x2
    3950:	2b0080e7          	jalr	688(ra) # 5bfc <printf>
    exit(1);
    3954:	4505                	li	a0,1
    ...
    3964:	c1850513          	addi	a0,a0,-1000 # 7578 <malloc+0x18c4>
    3968:	00002097          	auipc	ra,0x2
    396c:	294080e7          	jalr	660(ra) # 5bfc <printf>
    exit(1);
    3970:	4505                	li	a0,1
    ...
    3980:	c1c50513          	addi	a0,a0,-996 # 7598 <malloc+0x18e4>
    3984:	00002097          	auipc	ra,0x2
    3988:	278080e7          	jalr	632(ra) # 5bfc <printf>
    exit(1);
    398c:	4505                	li	a0,1
    ...
    399c:	c3050513          	addi	a0,a0,-976 # 75c8 <malloc+0x1914>
    39a0:	00002097          	auipc	ra,0x2
    39a4:	25c080e7          	jalr	604(ra) # 5bfc <printf>
    exit(1);
    39a8:	4505                	li	a0,1
    ...
    39b8:	c3450513          	addi	a0,a0,-972 # 75e8 <malloc+0x1934>
    39bc:	00002097          	auipc	ra,0x2
    39c0:	240080e7          	jalr	576(ra) # 5bfc <printf>
    exit(1);
    39c4:	4505                	li	a0,1
...
00000000000039ce <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    39de:	c2650513          	addi	a0,a0,-986 # 7600 <malloc+0x194c>
  ...
  if(chdir("dots") != 0){
    ...
    39f0:	c1450513          	addi	a0,a0,-1004 # 7600 <malloc+0x194c>
  ...
  if(unlink(".") == 0){
    ...
    3a02:	a9250513          	addi	a0,a0,-1390 # 6490 <malloc+0x7dc>
  ...
  if(unlink("..") == 0){
    ...
    3a14:	64850513          	addi	a0,a0,1608 # 7058 <malloc+0x13a4>
  ...
  if(chdir("/") != 0){
    ...
    3a26:	5de50513          	addi	a0,a0,1502 # 7000 <malloc+0x134c>
  ...
  if(unlink("dots/.") == 0){
    ...
    3a38:	c3450513          	addi	a0,a0,-972 # 7668 <malloc+0x19b4>
  ...
  if(unlink("dots/..") == 0){
    ...
    3a4a:	c4a50513          	addi	a0,a0,-950 # 7690 <malloc+0x19dc>
  ...
  if(unlink("dots") != 0){
    ...
    3a5c:	ba850513          	addi	a0,a0,-1112 # 7600 <malloc+0x194c>
    ...
    3a7a:	b9250513          	addi	a0,a0,-1134 # 7608 <malloc+0x1954>
    3a7e:	00002097          	auipc	ra,0x2
    3a82:	17e080e7          	jalr	382(ra) # 5bfc <printf>
    exit(1);
    3a86:	4505                	li	a0,1
    ...
    3a96:	b8e50513          	addi	a0,a0,-1138 # 7620 <malloc+0x196c>
    3a9a:	00002097          	auipc	ra,0x2
    3a9e:	162080e7          	jalr	354(ra) # 5bfc <printf>
    exit(1);
    3aa2:	4505                	li	a0,1
    ...
    3ab2:	b8a50513          	addi	a0,a0,-1142 # 7638 <malloc+0x1984>
    3ab6:	00002097          	auipc	ra,0x2
    3aba:	146080e7          	jalr	326(ra) # 5bfc <printf>
    exit(1);
    3abe:	4505                	li	a0,1
    ...
    3ace:	b8650513          	addi	a0,a0,-1146 # 7650 <malloc+0x199c>
    3ad2:	00002097          	auipc	ra,0x2
    3ad6:	12a080e7          	jalr	298(ra) # 5bfc <printf>
    exit(1);
    3ada:	4505                	li	a0,1
    ...
    3aea:	52250513          	addi	a0,a0,1314 # 7008 <malloc+0x1354>
    3aee:	00002097          	auipc	ra,0x2
    3af2:	10e080e7          	jalr	270(ra) # 5bfc <printf>
    exit(1);
    3af6:	4505                	li	a0,1
    ...
    3b06:	b6e50513          	addi	a0,a0,-1170 # 7670 <malloc+0x19bc>
    3b0a:	00002097          	auipc	ra,0x2
    3b0e:	0f2080e7          	jalr	242(ra) # 5bfc <printf>
    exit(1);
    3b12:	4505                	li	a0,1
    ...
    3b22:	b7a50513          	addi	a0,a0,-1158 # 7698 <malloc+0x19e4>
    3b26:	00002097          	auipc	ra,0x2
    3b2a:	0d6080e7          	jalr	214(ra) # 5bfc <printf>
    exit(1);
    3b2e:	4505                	li	a0,1
    ...
    3b3e:	b7e50513          	addi	a0,a0,-1154 # 76b8 <malloc+0x1a04>
    3b42:	00002097          	auipc	ra,0x2
    3b46:	0ba080e7          	jalr	186(ra) # 5bfc <printf>
    exit(1);
    3b4a:	4505                	li	a0,1
...
0000000000003b54 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3b6a:	b7250513          	addi	a0,a0,-1166 # 76d8 <malloc+0x1a24>
  ...
  if(chdir("dirfile") == 0){
    ...
    3b86:	b5650513          	addi	a0,a0,-1194 # 76d8 <malloc+0x1a24>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3b9a:	b8a50513          	addi	a0,a0,-1142 # 7720 <malloc+0x1a6c>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3bb2:	b7250513          	addi	a0,a0,-1166 # 7720 <malloc+0x1a6c>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3bc6:	b5e50513          	addi	a0,a0,-1186 # 7720 <malloc+0x1a6c>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3bda:	b4a50513          	addi	a0,a0,-1206 # 7720 <malloc+0x1a6c>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3bee:	b3658593          	addi	a1,a1,-1226 # 7720 <malloc+0x1a6c>
    3bf2:	00002517          	auipc	a0,0x2
    3bf6:	38e50513          	addi	a0,a0,910 # 5f80 <malloc+0x2cc>
  ...
  if(unlink("dirfile") != 0){
    ...
    3c0a:	ad250513          	addi	a0,a0,-1326 # 76d8 <malloc+0x1a24>
  ...
  fd = open(".", O_RDWR);
    ...
    3c20:	87450513          	addi	a0,a0,-1932 # 6490 <malloc+0x7dc>
  ...
  fd = open(".", 0);
    ...
    3c36:	85e50513          	addi	a0,a0,-1954 # 6490 <malloc+0x7dc>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3c4a:	20258593          	addi	a1,a1,514 # 5e48 <malloc+0x194>
  ...
  close(fd);
    ...
    3c76:	a6e50513          	addi	a0,a0,-1426 # 76e0 <malloc+0x1a2c>
    3c7a:	00002097          	auipc	ra,0x2
    3c7e:	f82080e7          	jalr	-126(ra) # 5bfc <printf>
    exit(1);
    3c82:	4505                	li	a0,1
    ...
    3c92:	a7250513          	addi	a0,a0,-1422 # 7700 <malloc+0x1a4c>
    3c96:	00002097          	auipc	ra,0x2
    3c9a:	f66080e7          	jalr	-154(ra) # 5bfc <printf>
    exit(1);
    3c9e:	4505                	li	a0,1
    ...
    3cae:	a8650513          	addi	a0,a0,-1402 # 7730 <malloc+0x1a7c>
    3cb2:	00002097          	auipc	ra,0x2
    3cb6:	f4a080e7          	jalr	-182(ra) # 5bfc <printf>
    exit(1);
    3cba:	4505                	li	a0,1
    ...
    3cca:	a6a50513          	addi	a0,a0,-1430 # 7730 <malloc+0x1a7c>
    3cce:	00002097          	auipc	ra,0x2
    3cd2:	f2e080e7          	jalr	-210(ra) # 5bfc <printf>
    exit(1);
    3cd6:	4505                	li	a0,1
    ...
    3ce6:	a7650513          	addi	a0,a0,-1418 # 7758 <malloc+0x1aa4>
    3cea:	00002097          	auipc	ra,0x2
    3cee:	f12080e7          	jalr	-238(ra) # 5bfc <printf>
    exit(1);
    3cf2:	4505                	li	a0,1
    ...
    3d02:	a8250513          	addi	a0,a0,-1406 # 7780 <malloc+0x1acc>
    3d06:	00002097          	auipc	ra,0x2
    3d0a:	ef6080e7          	jalr	-266(ra) # 5bfc <printf>
    exit(1);
    3d0e:	4505                	li	a0,1
    ...
    3d1e:	a8e50513          	addi	a0,a0,-1394 # 77a8 <malloc+0x1af4>
    3d22:	00002097          	auipc	ra,0x2
    3d26:	eda080e7          	jalr	-294(ra) # 5bfc <printf>
    exit(1);
    3d2a:	4505                	li	a0,1
    ...
    3d3a:	a9a50513          	addi	a0,a0,-1382 # 77d0 <malloc+0x1b1c>
    3d3e:	00002097          	auipc	ra,0x2
    3d42:	ebe080e7          	jalr	-322(ra) # 5bfc <printf>
    exit(1);
    3d46:	4505                	li	a0,1
    ...
    3d56:	a9e50513          	addi	a0,a0,-1378 # 77f0 <malloc+0x1b3c>
    3d5a:	00002097          	auipc	ra,0x2
    3d5e:	ea2080e7          	jalr	-350(ra) # 5bfc <printf>
    exit(1);
    3d62:	4505                	li	a0,1
    ...
    3d72:	aaa50513          	addi	a0,a0,-1366 # 7818 <malloc+0x1b64>
    3d76:	00002097          	auipc	ra,0x2
    3d7a:	e86080e7          	jalr	-378(ra) # 5bfc <printf>
    exit(1);
    3d7e:	4505                	li	a0,1
...
0000000000003d88 <iref>:
{
    ...
    3da6:	a8ea0a13          	addi	s4,s4,-1394 # 7830 <malloc+0x1b7c>
    mkdir("");
    3daa:	00003497          	auipc	s1,0x3
    3dae:	58e48493          	addi	s1,s1,1422 # 7338 <malloc+0x1684>
    link("README", "");
    3db2:	00002a97          	auipc	s5,0x2
    3db6:	1cea8a93          	addi	s5,s5,462 # 5f80 <malloc+0x2cc>
    fd = open("xx", O_CREATE);
    3dba:	00004997          	auipc	s3,0x4
    3dbe:	96e98993          	addi	s3,s3,-1682 # 7728 <malloc+0x1a74>
    3dc2:	a891                	j	3e16 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3dc4:	85da                	mv	a1,s6
    3dc6:	00004517          	auipc	a0,0x4
    3dca:	a7250513          	addi	a0,a0,-1422 # 7838 <malloc+0x1b84>
    3dce:	00002097          	auipc	ra,0x2
    3dd2:	e2e080e7          	jalr	-466(ra) # 5bfc <printf>
      exit(1);
    3dd6:	4505                	li	a0,1
    ...
    3de6:	a6e50513          	addi	a0,a0,-1426 # 7850 <malloc+0x1b9c>
    3dea:	00002097          	auipc	ra,0x2
    3dee:	e12080e7          	jalr	-494(ra) # 5bfc <printf>
      exit(1);
    3df2:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3e7a:	1e298993          	addi	s3,s3,482 # 7058 <malloc+0x13a4>
    unlink("irefd");
    3e7e:	00004917          	auipc	s2,0x4
    3e82:	9b290913          	addi	s2,s2,-1614 # 7830 <malloc+0x1b7c>
    chdir("..");
    3e86:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3ea2:	16250513          	addi	a0,a0,354 # 7000 <malloc+0x134c>
...
0000000000003ec2 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3ed2:	99a50513          	addi	a0,a0,-1638 # 7868 <malloc+0x1bb4>
  ...
  if(pid == 0){
    ...
    3ef6:	97650513          	addi	a0,a0,-1674 # 7868 <malloc+0x1bb4>
    ...
    3f0c:	98050513          	addi	a0,a0,-1664 # 7888 <malloc+0x1bd4>
    3f10:	00002097          	auipc	ra,0x2
    3f14:	cec080e7          	jalr	-788(ra) # 5bfc <printf>
      exit(1);
    3f18:	4505                	li	a0,1
    ...
    3f28:	94c50513          	addi	a0,a0,-1716 # 7870 <malloc+0x1bbc>
    3f2c:	00002097          	auipc	ra,0x2
    3f30:	cd0080e7          	jalr	-816(ra) # 5bfc <printf>
    exit(1);
    3f34:	4505                	li	a0,1
    ...
    3f44:	6f050513          	addi	a0,a0,1776 # 6630 <malloc+0x97c>
    3f48:	00002097          	auipc	ra,0x2
    3f4c:	cb4080e7          	jalr	-844(ra) # 5bfc <printf>
    exit(1);
    3f50:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3f72:	8fa50513          	addi	a0,a0,-1798 # 7868 <malloc+0x1bb4>
    ...
    3f86:	89e50513          	addi	a0,a0,-1890 # 6820 <malloc+0xb6c>
    3f8a:	00002097          	auipc	ra,0x2
    3f8e:	c72080e7          	jalr	-910(ra) # 5bfc <printf>
    exit(1);
    3f92:	4505                	li	a0,1
...
0000000000003fb4 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3fc4:	8f050513          	addi	a0,a0,-1808 # 78b0 <malloc+0x1bfc>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3ff0:	8c450513          	addi	a0,a0,-1852 # 78b0 <malloc+0x1bfc>
  ...
  sleep(10); // one second
    ...
    4028:	7cc50513          	addi	a0,a0,1996 # 67f0 <malloc+0xb3c>
    402c:	00002097          	auipc	ra,0x2
    4030:	bd0080e7          	jalr	-1072(ra) # 5bfc <printf>
    exit(1);
    4034:	4505                	li	a0,1
    ...
    4042:	87248493          	addi	s1,s1,-1934 # 78b0 <malloc+0x1bfc>
    4046:	4581                	li	a1,0
    4048:	8526                	mv	a0,s1
...
0000000000004084 <killstatus>:
{
  ...
  exit(0);
    ...
    40ea:	54a50513          	addi	a0,a0,1354 # 6630 <malloc+0x97c>
    40ee:	00002097          	auipc	ra,0x2
    40f2:	b0e080e7          	jalr	-1266(ra) # 5bfc <printf>
      exit(1);
    40f6:	4505                	li	a0,1
    ...
    4110:	7b450513          	addi	a0,a0,1972 # 78c0 <malloc+0x1c0c>
    4114:	00002097          	auipc	ra,0x2
    4118:	ae8080e7          	jalr	-1304(ra) # 5bfc <printf>
       exit(1);
    411c:	4505                	li	a0,1
...
0000000000004126 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    4150:	6a450513          	addi	a0,a0,1700 # 67f0 <malloc+0xb3c>
    4154:	00002097          	auipc	ra,0x2
    4158:	aa8080e7          	jalr	-1368(ra) # 5bfc <printf>
    exit(1);
    415c:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    417e:	4b650513          	addi	a0,a0,1206 # 6630 <malloc+0x97c>
    4182:	00002097          	auipc	ra,0x2
    4186:	a7a080e7          	jalr	-1414(ra) # 5bfc <printf>
    exit(1);
    418a:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    41c2:	c8a58593          	addi	a1,a1,-886 # 5e48 <malloc+0x194>
    ...
    41ec:	44850513          	addi	a0,a0,1096 # 6630 <malloc+0x97c>
    41f0:	00002097          	auipc	ra,0x2
    41f4:	a0c080e7          	jalr	-1524(ra) # 5bfc <printf>
     exit(1);
    41f8:	4505                	li	a0,1
    ...
    4208:	6dc50513          	addi	a0,a0,1756 # 78e0 <malloc+0x1c2c>
    420c:	00002097          	auipc	ra,0x2
    4210:	9f0080e7          	jalr	-1552(ra) # 5bfc <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    4228:	bf458593          	addi	a1,a1,-1036 # be18 <buf>
    ...
    4244:	6b850513          	addi	a0,a0,1720 # 78f8 <malloc+0x1c44>
    4248:	00002097          	auipc	ra,0x2
    424c:	9b4080e7          	jalr	-1612(ra) # 5bfc <printf>
}
  ...
  printf("kill... ");
    ...
    4270:	6a450513          	addi	a0,a0,1700 # 7910 <malloc+0x1c5c>
    4274:	00002097          	auipc	ra,0x2
    4278:	988080e7          	jalr	-1656(ra) # 5bfc <printf>
  kill(pid1);
    427c:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    429e:	68650513          	addi	a0,a0,1670 # 7920 <malloc+0x1c6c>
    42a2:	00002097          	auipc	ra,0x2
    42a6:	95a080e7          	jalr	-1702(ra) # 5bfc <printf>
  wait(0);
    42aa:	4501                	li	a0,0
...
00000000000042ca <reparent>:
{
  ...
  exit(0);
    ...
    431e:	31650513          	addi	a0,a0,790 # 6630 <malloc+0x97c>
    4322:	00002097          	auipc	ra,0x2
    4326:	8da080e7          	jalr	-1830(ra) # 5bfc <printf>
      exit(1);
    432a:	4505                	li	a0,1
    ...
    433a:	48250513          	addi	a0,a0,1154 # 67b8 <malloc+0xb04>
    433e:	00002097          	auipc	ra,0x2
    4342:	8be080e7          	jalr	-1858(ra) # 5bfc <printf>
        exit(1);
    4346:	4505                	li	a0,1
...
000000000000437a <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    43b0:	38c50513          	addi	a0,a0,908 # 6738 <malloc+0xa84>
    43b4:	00002097          	auipc	ra,0x2
    43b8:	848080e7          	jalr	-1976(ra) # 5bfc <printf>
    exit(1);
    43bc:	4505                	li	a0,1
    ...
    43e4:	a6858593          	addi	a1,a1,-1432 # 5e48 <malloc+0x194>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    44a8:	48c50513          	addi	a0,a0,1164 # 7930 <malloc+0x1c7c>
    44ac:	00001097          	auipc	ra,0x1
    44b0:	750080e7          	jalr	1872(ra) # 5bfc <printf>
    exit(1);
    44b4:	4505                	li	a0,1
    ...
    44c4:	17050513          	addi	a0,a0,368 # 6630 <malloc+0x97c>
    44c8:	00001097          	auipc	ra,0x1
    44cc:	734080e7          	jalr	1844(ra) # 5bfc <printf>
    exit(1);
    44d0:	4505                	li	a0,1
    ...
    44fa:	6705                	lui	a4,0x1
      n += *(a+i);
    44fc:	0007c683          	lbu	a3,0(a5) # 6400000 <__BSS_END__+0x63f11d8>
    ...
    4510:	44450513          	addi	a0,a0,1092 # 7950 <malloc+0x1c9c>
    4514:	00001097          	auipc	ra,0x1
    4518:	6e8080e7          	jalr	1768(ra) # 5bfc <printf>
    exit(1);
    451c:	4505                	li	a0,1
...
0000000000004530 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    457a:	73e080e7          	jalr	1854(ra) # 5cb4 <malloc>
    ...
    45b4:	3d050513          	addi	a0,a0,976 # 7980 <malloc+0x1ccc>
    45b8:	00001097          	auipc	ra,0x1
    45bc:	644080e7          	jalr	1604(ra) # 5bfc <printf>
      exit(1);
    45c0:	4505                	li	a0,1
...
00000000000045d4 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    466a:	34a50513          	addi	a0,a0,842 # 79b0 <malloc+0x1cfc>
    466e:	00001097          	auipc	ra,0x1
    4672:	58e080e7          	jalr	1422(ra) # 5bfc <printf>
    exit(1);
    4676:	4505                	li	a0,1
    ...
    4686:	35650513          	addi	a0,a0,854 # 79d8 <malloc+0x1d24>
    468a:	00001097          	auipc	ra,0x1
    468e:	572080e7          	jalr	1394(ra) # 5bfc <printf>
      exit(1);
    4692:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    46ca:	2da50513          	addi	a0,a0,730 # 79a0 <malloc+0x1cec>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    470a:	2f250513          	addi	a0,a0,754 # 79f8 <malloc+0x1d44>
    470e:	00001097          	auipc	ra,0x1
    4712:	4ee080e7          	jalr	1262(ra) # 5bfc <printf>
    exit(1);
    4716:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    4746:	25e50513          	addi	a0,a0,606 # 79a0 <malloc+0x1cec>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    476c:	2b850513          	addi	a0,a0,696 # 7a20 <malloc+0x1d6c>
    4770:	00001097          	auipc	ra,0x1
    4774:	48c080e7          	jalr	1164(ra) # 5bfc <printf>
    exit(1);
    4778:	4505                	li	a0,1
...
000000000000478c <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    47b2:	28a78793          	addi	a5,a5,650 # 7a38 <malloc+0x1d84>
    47b6:	f6f43823          	sd	a5,-144(s0)
    47ba:	00003797          	auipc	a5,0x3
    47be:	28678793          	addi	a5,a5,646 # 7a40 <malloc+0x1d8c>
    47c2:	f6f43c23          	sd	a5,-136(s0)
    47c6:	00003797          	auipc	a5,0x3
    47ca:	28278793          	addi	a5,a5,642 # 7a48 <malloc+0x1d94>
    47ce:	f8f43023          	sd	a5,-128(s0)
    47d2:	00003797          	auipc	a5,0x3
    47d6:	27e78793          	addi	a5,a5,638 # 7a50 <malloc+0x1d9c>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    482e:	5eea0a13          	addi	s4,s4,1518 # be18 <buf>
    4832:	00007a97          	auipc	s5,0x7
    4836:	5e7a8a93          	addi	s5,s5,1511 # be19 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    484e:	20650513          	addi	a0,a0,518 # 6a50 <malloc+0xd9c>
    4852:	00001097          	auipc	ra,0x1
    4856:	3aa080e7          	jalr	938(ra) # 5bfc <printf>
      exit(1);
    485a:	4505                	li	a0,1
    ...
    48ca:	19250513          	addi	a0,a0,402 # 7a58 <malloc+0x1da4>
    48ce:	00001097          	auipc	ra,0x1
    48d2:	32e080e7          	jalr	814(ra) # 5bfc <printf>
        exit(1);
    48d6:	4505                	li	a0,1
    ...
    48e4:	18850513          	addi	a0,a0,392 # 7a68 <malloc+0x1db4>
    48e8:	00001097          	auipc	ra,0x1
    48ec:	314080e7          	jalr	788(ra) # 5bfc <printf>
          exit(1);
    48f0:	4505                	li	a0,1
    ...
    490c:	17850513          	addi	a0,a0,376 # 7a80 <malloc+0x1dcc>
    4910:	00001097          	auipc	ra,0x1
    4914:	2ec080e7          	jalr	748(ra) # 5bfc <printf>
          exit(1);
    4918:	4505                	li	a0,1
    ...
    493c:	4e078793          	addi	a5,a5,1248 # be18 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    499a:	0fa50513          	addi	a0,a0,250 # 7a90 <malloc+0x1ddc>
    499e:	00001097          	auipc	ra,0x1
    49a2:	25e080e7          	jalr	606(ra) # 5bfc <printf>
      exit(1);
    49a6:	4505                	li	a0,1
...
00000000000049ce <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    49fc:	0b0b8b93          	addi	s7,s7,176 # 7aa8 <malloc+0x1df4>
  for(i = 0; i < N; i++){
    ...
    4a3e:	07650513          	addi	a0,a0,118 # 7ab0 <malloc+0x1dfc>
    4a42:	00001097          	auipc	ra,0x1
    4a46:	1ba080e7          	jalr	442(ra) # 5bfc <printf>
        exit(1);
    4a4a:	4505                	li	a0,1
    ...
    4a5c:	05050513          	addi	a0,a0,80 # 7aa8 <malloc+0x1df4>
  ...
  fd = open(".", 0);
    ...
    4a94:	a0050513          	addi	a0,a0,-1536 # 6490 <malloc+0x7dc>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4b0c:	fc850513          	addi	a0,a0,-56 # 7ad0 <malloc+0x1e1c>
    4b10:	00001097          	auipc	ra,0x1
    4b14:	0ec080e7          	jalr	236(ra) # 5bfc <printf>
        exit(1);
    4b18:	4505                	li	a0,1
    ...
    4b2c:	fc850513          	addi	a0,a0,-56 # 7af0 <malloc+0x1e3c>
    4b30:	00001097          	auipc	ra,0x1
    4b34:	0cc080e7          	jalr	204(ra) # 5bfc <printf>
        exit(1);
    4b38:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4b64:	fb850513          	addi	a0,a0,-72 # 7b18 <malloc+0x1e64>
    4b68:	00001097          	auipc	ra,0x1
    4b6c:	094080e7          	jalr	148(ra) # 5bfc <printf>
    exit(1);
    4b70:	4505                	li	a0,1
    ...
    4b80:	ab450513          	addi	a0,a0,-1356 # 6630 <malloc+0x97c>
    4b84:	00001097          	auipc	ra,0x1
    4b88:	078080e7          	jalr	120(ra) # 5bfc <printf>
      exit(1);
    4b8c:	4505                	li	a0,1
...
0000000000004d2a <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4d6a:	0b290913          	addi	s2,s2,178 # be18 <buf>
  for(i = 0; i < N; i++){
    4d6e:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    4db2:	da250513          	addi	a0,a0,-606 # 7b50 <malloc+0x1e9c>
  ...
  for(i = 0; ; i++){
    ...
    4dc8:	05490913          	addi	s2,s2,84 # be18 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4e16:	d4e50513          	addi	a0,a0,-690 # 7b60 <malloc+0x1eac>
    4e1a:	00001097          	auipc	ra,0x1
    4e1e:	de2080e7          	jalr	-542(ra) # 5bfc <printf>
    exit(1);
    4e22:	4505                	li	a0,1
    ...
    4e32:	d5250513          	addi	a0,a0,-686 # 7b80 <malloc+0x1ecc>
    4e36:	00001097          	auipc	ra,0x1
    4e3a:	dc6080e7          	jalr	-570(ra) # 5bfc <printf>
      exit(1);
    4e3e:	4505                	li	a0,1
    ...
    4e4e:	d5650513          	addi	a0,a0,-682 # 7ba0 <malloc+0x1eec>
    4e52:	00001097          	auipc	ra,0x1
    4e56:	daa080e7          	jalr	-598(ra) # 5bfc <printf>
    exit(1);
    4e5a:	4505                	li	a0,1
    ...
    4e6a:	d5a50513          	addi	a0,a0,-678 # 7bc0 <malloc+0x1f0c>
    4e6e:	00001097          	auipc	ra,0x1
    4e72:	d8e080e7          	jalr	-626(ra) # 5bfc <printf>
      exit(1);
    4e76:	4505                	li	a0,1
    ...
    4e86:	d5e50513          	addi	a0,a0,-674 # 7be0 <malloc+0x1f2c>
    4e8a:	00001097          	auipc	ra,0x1
    4e8e:	d72080e7          	jalr	-654(ra) # 5bfc <printf>
      exit(1);
    4e92:	4505                	li	a0,1
    ...
    4ea2:	d5a50513          	addi	a0,a0,-678 # 7bf8 <malloc+0x1f44>
    4ea6:	00001097          	auipc	ra,0x1
    4eaa:	d56080e7          	jalr	-682(ra) # 5bfc <printf>
      exit(1);
    4eae:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    4ed0:	c8450513          	addi	a0,a0,-892 # 7b50 <malloc+0x1e9c>
    ...
    4ef4:	d2850513          	addi	a0,a0,-728 # 7c18 <malloc+0x1f64>
    4ef8:	00001097          	auipc	ra,0x1
    4efc:	d04080e7          	jalr	-764(ra) # 5bfc <printf>
    exit(1);
    4f00:	4505                	li	a0,1
...
0000000000004f0a <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4f2c:	d1050513          	addi	a0,a0,-752 # 7c38 <malloc+0x1f84>
    4f30:	00001097          	auipc	ra,0x1
    4f34:	ccc080e7          	jalr	-820(ra) # 5bfc <printf>
  for(nfiles = 0; ; nfiles++){
    4f38:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4f4c:	d00c8c93          	addi	s9,s9,-768 # 7c48 <malloc+0x1f94>
    int total = 0;
    4f50:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    4f52:	00007a17          	auipc	s4,0x7
    4f56:	ec6a0a13          	addi	s4,s4,-314 # be18 <buf>
    name[0] = 'f';
    ...
    4fa4:	c5c080e7          	jalr	-932(ra) # 5bfc <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    4fc6:	c9650513          	addi	a0,a0,-874 # 7c58 <malloc+0x1fa4>
    4fca:	00001097          	auipc	ra,0x1
    4fce:	c32080e7          	jalr	-974(ra) # 5bfc <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    503c:	c4050513          	addi	a0,a0,-960 # 7c78 <malloc+0x1fc4>
    5040:	00001097          	auipc	ra,0x1
    5044:	bbc080e7          	jalr	-1092(ra) # 5bfc <printf>
}
    ...
    508c:	be050513          	addi	a0,a0,-1056 # 7c68 <malloc+0x1fb4>
    5090:	00001097          	auipc	ra,0x1
    5094:	b6c080e7          	jalr	-1172(ra) # 5bfc <printf>
    close(fd);
    5098:	854a                	mv	a0,s2
...
00000000000050aa <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    511e:	b7650513          	addi	a0,a0,-1162 # 7c90 <malloc+0x1fdc>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    5136:	d1658593          	addi	a1,a1,-746 # 5e48 <malloc+0x194>
    ...
    514c:	b6850513          	addi	a0,a0,-1176 # 7cb0 <malloc+0x1ffc>
    5150:	00001097          	auipc	ra,0x1
    5154:	aac080e7          	jalr	-1364(ra) # 5bfc <printf>
    exit(1);
    5158:	4505                	li	a0,1
    ...
    5166:	b3650513          	addi	a0,a0,-1226 # 7c98 <malloc+0x1fe4>
    516a:	00001097          	auipc	ra,0x1
    516e:	a92080e7          	jalr	-1390(ra) # 5bfc <printf>
      exit(1);
    5172:	4505                	li	a0,1
    ...
    5180:	b1c50513          	addi	a0,a0,-1252 # 7c98 <malloc+0x1fe4>
    5184:	00001097          	auipc	ra,0x1
    5188:	a78080e7          	jalr	-1416(ra) # 5bfc <printf>
    exit(1);
    518c:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    51a4:	af050513          	addi	a0,a0,-1296 # 7c90 <malloc+0x1fdc>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    51fa:	c5298993          	addi	s3,s3,-942 # 5e48 <malloc+0x194>
      uint64 a = (uint64) sbrk(4096);
    ...
    522c:	ad850513          	addi	a0,a0,-1320 # 7d00 <malloc+0x204c>
    5230:	00001097          	auipc	ra,0x1
    5234:	9cc080e7          	jalr	-1588(ra) # 5bfc <printf>
        exit(1);
    5238:	4505                	li	a0,1
    ...
    5246:	a7e50513          	addi	a0,a0,-1410 # 7cc0 <malloc+0x200c>
    524a:	00001097          	auipc	ra,0x1
    524e:	9b2080e7          	jalr	-1614(ra) # 5bfc <printf>
    exit(1);
    5252:	4505                	li	a0,1
    ...
    5260:	a8450513          	addi	a0,a0,-1404 # 7ce0 <malloc+0x202c>
    5264:	00001097          	auipc	ra,0x1
    5268:	998080e7          	jalr	-1640(ra) # 5bfc <printf>
    exit(1);
    526c:	4505                	li	a0,1
  ...
  while(1){
    ...
    52ae:	a7650513          	addi	a0,a0,-1418 # 7d20 <malloc+0x206c>
    52b2:	00001097          	auipc	ra,0x1
    52b6:	94a080e7          	jalr	-1718(ra) # 5bfc <printf>
      exit(1);
    52ba:	4505                	li	a0,1
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    52fe:	a4650513          	addi	a0,a0,-1466 # 7d40 <malloc+0x208c>
    5302:	00001097          	auipc	ra,0x1
    5306:	8fa080e7          	jalr	-1798(ra) # 5bfc <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    532e:	a3e50513          	addi	a0,a0,-1474 # 7d68 <malloc+0x20b4>
    5332:	00001097          	auipc	ra,0x1
    5336:	8ca080e7          	jalr	-1846(ra) # 5bfc <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    5352:	a0250513          	addi	a0,a0,-1534 # 7d50 <malloc+0x209c>
    5356:	00001097          	auipc	ra,0x1
    535a:	8a6080e7          	jalr	-1882(ra) # 5bfc <printf>
    exit(1);
    535e:	4505                	li	a0,1
    ...
    537a:	9fa50513          	addi	a0,a0,-1542 # 7d70 <malloc+0x20bc>
    537e:	00001097          	auipc	ra,0x1
    5382:	87e080e7          	jalr	-1922(ra) # 5bfc <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    53c4:	dc878793          	addi	a5,a5,-568 # 8188 <malloc+0x24d4>
    53c8:	bd040713          	addi	a4,s0,-1072
    53cc:	00003317          	auipc	t1,0x3
    53d0:	1ac30313          	addi	t1,t1,428 # 8578 <malloc+0x28c4>
  ...
  printf("usertests starting\n");
    ...
    5404:	a2850513          	addi	a0,a0,-1496 # 7e28 <malloc+0x2174>
    5408:	00000097          	auipc	ra,0x0
    540c:	7f4080e7          	jalr	2036(ra) # 5bfc <printf>
  int free0 = countfree();
  ...
  if(fail){
    ...
    543c:	9a850513          	addi	a0,a0,-1624 # 7de0 <malloc+0x212c>
    5440:	00000097          	auipc	ra,0x0
    5444:	7bc080e7          	jalr	1980(ra) # 5bfc <printf>
    exit(1);
    5448:	4505                	li	a0,1
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    5458:	92458593          	addi	a1,a1,-1756 # 7d78 <malloc+0x20c4>
    ...
    546e:	9f658593          	addi	a1,a1,-1546 # 7e60 <malloc+0x21ac>
    ...
    5492:	8f250513          	addi	a0,a0,-1806 # 7d80 <malloc+0x20cc>
    5496:	00000097          	auipc	ra,0x0
    549a:	766080e7          	jalr	1894(ra) # 5bfc <printf>
    exit(1);
    549e:	4505                	li	a0,1
    ...
    54bc:	744080e7          	jalr	1860(ra) # 5bfc <printf>
        if(continuous != 2)
  ...
  if(fail){
    ...
    54fe:	8ce50513          	addi	a0,a0,-1842 # 7dc8 <malloc+0x2114>
    5502:	00000097          	auipc	ra,0x0
    5506:	6fa080e7          	jalr	1786(ra) # 5bfc <printf>
    exit(1);
    550a:	4505                	li	a0,1
    ...
    5518:	8fc50513          	addi	a0,a0,-1796 # 7e10 <malloc+0x215c>
    551c:	00000097          	auipc	ra,0x0
    5520:	6e0080e7          	jalr	1760(ra) # 5bfc <printf>
    exit(0);
    5524:	4501                	li	a0,0
    ...
    5534:	6cc080e7          	jalr	1740(ra) # 5bfc <printf>
        if(continuous != 2)
    ...
    5576:	c1678793          	addi	a5,a5,-1002 # 8188 <malloc+0x24d4>
    557a:	bd040713          	addi	a4,s0,-1072
    557e:	00003317          	auipc	t1,0x3
    5582:	ffa30313          	addi	t1,t1,-6 # 8578 <malloc+0x28c4>
    ...
    55b6:	88e50513          	addi	a0,a0,-1906 # 7e40 <malloc+0x218c>
    55ba:	00000097          	auipc	ra,0x0
    55be:	642080e7          	jalr	1602(ra) # 5bfc <printf>
        printf("SOME TESTS FAILED\n");
    55c2:	00003a97          	auipc	s5,0x3
    55c6:	806a8a93          	addi	s5,s5,-2042 # 7dc8 <malloc+0x2114>
        if(continuous != 2)
    55ca:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    55cc:	00002b17          	auipc	s6,0x2
    55d0:	7dcb0b13          	addi	s6,s6,2012 # 7da8 <malloc+0x20f4>
...
putc(int fd, char c)
{
    5922:	1101                	addi	sp,sp,-32
    5924:	ec06                	sd	ra,24(sp)
    5926:	e822                	sd	s0,16(sp)
    5928:	1000                	addi	s0,sp,32
    592a:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    592e:	4605                	li	a2,1
    5930:	fef40593          	addi	a1,s0,-17
    5934:	00000097          	auipc	ra,0x0
    5938:	f2e080e7          	jalr	-210(ra) # 5862 <write>
}
    593c:	60e2                	ld	ra,24(sp)
    593e:	6442                	ld	s0,16(sp)
    5940:	6105                	addi	sp,sp,32
    5942:	8082                	ret

0000000000005944 <printint>:
...
printint(int fd, int xx, int base, int sgn)
{
    ...
    594a:	f426                	sd	s1,40(sp)
    594c:	f04a                	sd	s2,32(sp)
    594e:	ec4e                	sd	s3,24(sp)
    5950:	0080                	addi	s0,sp,64
    5952:	84aa                	mv	s1,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    5954:	c299                	beqz	a3,595a <printint+0x16>
    5956:	0805c963          	bltz	a1,59e8 <printint+0xa4>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    595a:	2581                	sext.w	a1,a1
  neg = 0;
    595c:	4881                	li	a7,0
    595e:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    5964:	2601                	sext.w	a2,a2
    5966:	00003517          	auipc	a0,0x3
    596a:	c7250513          	addi	a0,a0,-910 # 85d8 <digits>
    596e:	883a                	mv	a6,a4
    5970:	2705                	addiw	a4,a4,1
    5972:	02c5f7bb          	remuw	a5,a1,a2
    5976:	1782                	slli	a5,a5,0x20
    5978:	9381                	srli	a5,a5,0x20
    597a:	97aa                	add	a5,a5,a0
    597c:	0007c783          	lbu	a5,0(a5)
    5980:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    5984:	0005879b          	sext.w	a5,a1
    5988:	02c5d5bb          	divuw	a1,a1,a2
    598c:	0685                	addi	a3,a3,1
    598e:	fec7f0e3          	bgeu	a5,a2,596e <printint+0x2a>
  if(neg)
    5992:	00088c63          	beqz	a7,59aa <printint+0x66>
    buf[i++] = '-';
    5996:	fd070793          	addi	a5,a4,-48
    599a:	00878733          	add	a4,a5,s0
    599e:	02d00793          	li	a5,45
    59a2:	fef70823          	sb	a5,-16(a4)
    59a6:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    59aa:	02e05863          	blez	a4,59da <printint+0x96>
    59ae:	fc040793          	addi	a5,s0,-64
    59b2:	00e78933          	add	s2,a5,a4
    59b6:	fff78993          	addi	s3,a5,-1
    59ba:	99ba                	add	s3,s3,a4
    59bc:	377d                	addiw	a4,a4,-1
    59be:	1702                	slli	a4,a4,0x20
    59c0:	9301                	srli	a4,a4,0x20
    59c2:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    59c6:	fff94583          	lbu	a1,-1(s2)
    59ca:	8526                	mv	a0,s1
    59cc:	00000097          	auipc	ra,0x0
    59d0:	f56080e7          	jalr	-170(ra) # 5922 <putc>
  while(--i >= 0)
    59d4:	197d                	addi	s2,s2,-1
    59d6:	ff3918e3          	bne	s2,s3,59c6 <printint+0x82>
}
    59da:	70e2                	ld	ra,56(sp)
    59dc:	7442                	ld	s0,48(sp)
    59de:	74a2                	ld	s1,40(sp)
    59e0:	7902                	ld	s2,32(sp)
    59e2:	69e2                	ld	s3,24(sp)
    59e4:	6121                	addi	sp,sp,64
    59e6:	8082                	ret
    x = -xx;
    59e8:	40b005bb          	negw	a1,a1
    neg = 1;
    59ec:	4885                	li	a7,1
    x = -xx;
    59ee:	bf85                	j	595e <printint+0x1a>

00000000000059f0 <vprintf>:
}
...
{
    59f0:	7119                	addi	sp,sp,-128
    59f2:	fc86                	sd	ra,120(sp)
    59f4:	f8a2                	sd	s0,112(sp)
    59f6:	f4a6                	sd	s1,104(sp)
    59f8:	f0ca                	sd	s2,96(sp)
    59fa:	ecce                	sd	s3,88(sp)
    59fc:	e8d2                	sd	s4,80(sp)
    59fe:	e4d6                	sd	s5,72(sp)
    5a00:	e0da                	sd	s6,64(sp)
    5a02:	fc5e                	sd	s7,56(sp)
    5a04:	f862                	sd	s8,48(sp)
    5a06:	f466                	sd	s9,40(sp)
    5a08:	f06a                	sd	s10,32(sp)
    5a0a:	ec6e                	sd	s11,24(sp)
  ...
  state = 0;
  for(i = 0; fmt[i]; i++){
    5a0e:	0005c903          	lbu	s2,0(a1)
    5a12:	18090f63          	beqz	s2,5bb0 <vprintf+0x1c0>
    5a16:	8aaa                	mv	s5,a0
    5a18:	8b32                	mv	s6,a2
    5a1a:	00158493          	addi	s1,a1,1
  state = 0;
    5a1e:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    5a20:	02500a13          	li	s4,37
    5a24:	4c55                	li	s8,21
    5a26:	00003c97          	auipc	s9,0x3
    5a2a:	b5ac8c93          	addi	s9,s9,-1190 # 8580 <malloc+0x28cc>
        ...
        if(s == 0)
          s = "(null)";
        while(*s != 0){
    5a2e:	02800d93          	li	s11,40
  putc(fd, 'x');
    5a32:	4d41                	li	s10,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5a34:	00003b97          	auipc	s7,0x3
    5a38:	ba4b8b93          	addi	s7,s7,-1116 # 85d8 <digits>
    5a3c:	a839                	j	5a5a <vprintf+0x6a>
        putc(fd, c);
    5a3e:	85ca                	mv	a1,s2
    5a40:	8556                	mv	a0,s5
    5a42:	00000097          	auipc	ra,0x0
    5a46:	ee0080e7          	jalr	-288(ra) # 5922 <putc>
    5a4a:	a019                	j	5a50 <vprintf+0x60>
    } else if(state == '%'){
    5a4c:	01498d63          	beq	s3,s4,5a66 <vprintf+0x76>
  for(i = 0; fmt[i]; i++){
    5a50:	0485                	addi	s1,s1,1
    5a52:	fff4c903          	lbu	s2,-1(s1)
    5a56:	14090d63          	beqz	s2,5bb0 <vprintf+0x1c0>
    if(state == 0){
    5a5a:	fe0999e3          	bnez	s3,5a4c <vprintf+0x5c>
      if(c == '%'){
    5a5e:	ff4910e3          	bne	s2,s4,5a3e <vprintf+0x4e>
        state = '%';
    5a62:	89d2                	mv	s3,s4
    5a64:	b7f5                	j	5a50 <vprintf+0x60>
      if(c == 'd'){
    5a66:	11490c63          	beq	s2,s4,5b7e <vprintf+0x18e>
    5a6a:	f9d9079b          	addiw	a5,s2,-99
    5a6e:	0ff7f793          	zext.b	a5,a5
    5a72:	10fc6e63          	bltu	s8,a5,5b8e <vprintf+0x19e>
    5a76:	f9d9079b          	addiw	a5,s2,-99
    5a7a:	0ff7f713          	zext.b	a4,a5
    5a7e:	10ec6863          	bltu	s8,a4,5b8e <vprintf+0x19e>
    5a82:	00271793          	slli	a5,a4,0x2
    5a86:	97e6                	add	a5,a5,s9
    5a88:	439c                	lw	a5,0(a5)
    5a8a:	97e6                	add	a5,a5,s9
    5a8c:	8782                	jr	a5
    ...
    5aa0:	ea8080e7          	jalr	-344(ra) # 5944 <printint>
    5aa4:	8b4a                	mv	s6,s2
      } else {
      ...
      state = 0;
    5aa6:	4981                	li	s3,0
    5aa8:	b765                	j	5a50 <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    5aaa:	008b0913          	addi	s2,s6,8
    5aae:	4681                	li	a3,0
    5ab0:	4629                	li	a2,10
    5ab2:	000b2583          	lw	a1,0(s6)
    5ab6:	8556                	mv	a0,s5
    5ab8:	00000097          	auipc	ra,0x0
    5abc:	e8c080e7          	jalr	-372(ra) # 5944 <printint>
    5ac0:	8b4a                	mv	s6,s2
      state = 0;
    5ac2:	4981                	li	s3,0
    5ac4:	b771                	j	5a50 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    5ac6:	008b0913          	addi	s2,s6,8
    5aca:	4681                	li	a3,0
    5acc:	866a                	mv	a2,s10
    5ace:	000b2583          	lw	a1,0(s6)
    5ad2:	8556                	mv	a0,s5
    5ad4:	00000097          	auipc	ra,0x0
    5ad8:	e70080e7          	jalr	-400(ra) # 5944 <printint>
    5adc:	8b4a                	mv	s6,s2
      state = 0;
    5ade:	4981                	li	s3,0
    5ae0:	bf85                	j	5a50 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    5ae2:	008b0793          	addi	a5,s6,8
    5ae6:	f8f43423          	sd	a5,-120(s0)
    5aea:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    5aee:	03000593          	li	a1,48
    5af2:	8556                	mv	a0,s5
    5af4:	00000097          	auipc	ra,0x0
    5af8:	e2e080e7          	jalr	-466(ra) # 5922 <putc>
  putc(fd, 'x');
    5afc:	07800593          	li	a1,120
    5b00:	8556                	mv	a0,s5
    5b02:	00000097          	auipc	ra,0x0
    5b06:	e20080e7          	jalr	-480(ra) # 5922 <putc>
    5b0a:	896a                	mv	s2,s10
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    ...
    5b1c:	e0a080e7          	jalr	-502(ra) # 5922 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5b20:	0992                	slli	s3,s3,0x4
    5b22:	397d                	addiw	s2,s2,-1
    5b24:	fe0914e3          	bnez	s2,5b0c <vprintf+0x11c>
        printptr(fd, va_arg(ap, uint64));
    5b28:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    5b2c:	4981                	li	s3,0
    5b2e:	b70d                	j	5a50 <vprintf+0x60>
        s = va_arg(ap, char*);
    5b30:	008b0913          	addi	s2,s6,8
    5b34:	000b3983          	ld	s3,0(s6)
        if(s == 0)
    5b38:	02098163          	beqz	s3,5b5a <vprintf+0x16a>
        while(*s != 0){
    5b3c:	0009c583          	lbu	a1,0(s3)
    5b40:	c5ad                	beqz	a1,5baa <vprintf+0x1ba>
          putc(fd, *s);
    5b42:	8556                	mv	a0,s5
    5b44:	00000097          	auipc	ra,0x0
    5b48:	dde080e7          	jalr	-546(ra) # 5922 <putc>
          s++;
    5b4c:	0985                	addi	s3,s3,1
        while(*s != 0){
    5b4e:	0009c583          	lbu	a1,0(s3)
    5b52:	f9e5                	bnez	a1,5b42 <vprintf+0x152>
        s = va_arg(ap, char*);
    5b54:	8b4a                	mv	s6,s2
      state = 0;
    5b56:	4981                	li	s3,0
    5b58:	bde5                	j	5a50 <vprintf+0x60>
          s = "(null)";
    5b5a:	00003997          	auipc	s3,0x3
    5b5e:	a1e98993          	addi	s3,s3,-1506 # 8578 <malloc+0x28c4>
        while(*s != 0){
    5b62:	85ee                	mv	a1,s11
    5b64:	bff9                	j	5b42 <vprintf+0x152>
        putc(fd, va_arg(ap, uint));
    5b66:	008b0913          	addi	s2,s6,8
    5b6a:	000b4583          	lbu	a1,0(s6)
    5b6e:	8556                	mv	a0,s5
    5b70:	00000097          	auipc	ra,0x0
    5b74:	db2080e7          	jalr	-590(ra) # 5922 <putc>
    5b78:	8b4a                	mv	s6,s2
      state = 0;
    5b7a:	4981                	li	s3,0
    5b7c:	bdd1                	j	5a50 <vprintf+0x60>
        putc(fd, c);
    5b7e:	85d2                	mv	a1,s4
    5b80:	8556                	mv	a0,s5
    5b82:	00000097          	auipc	ra,0x0
    5b86:	da0080e7          	jalr	-608(ra) # 5922 <putc>
      state = 0;
    5b8a:	4981                	li	s3,0
    5b8c:	b5d1                	j	5a50 <vprintf+0x60>
        putc(fd, '%');
    5b8e:	85d2                	mv	a1,s4
    5b90:	8556                	mv	a0,s5
    5b92:	00000097          	auipc	ra,0x0
    5b96:	d90080e7          	jalr	-624(ra) # 5922 <putc>
        putc(fd, c);
    5b9a:	85ca                	mv	a1,s2
    5b9c:	8556                	mv	a0,s5
    5b9e:	00000097          	auipc	ra,0x0
    5ba2:	d84080e7          	jalr	-636(ra) # 5922 <putc>
      state = 0;
    5ba6:	4981                	li	s3,0
    5ba8:	b565                	j	5a50 <vprintf+0x60>
        s = va_arg(ap, char*);
    5baa:	8b4a                	mv	s6,s2
      state = 0;
    5bac:	4981                	li	s3,0
    5bae:	b54d                	j	5a50 <vprintf+0x60>
    }
  }
}
    5bb0:	70e6                	ld	ra,120(sp)
    5bb2:	7446                	ld	s0,112(sp)
    5bb4:	74a6                	ld	s1,104(sp)
    5bb6:	7906                	ld	s2,96(sp)
    5bb8:	69e6                	ld	s3,88(sp)
    5bba:	6a46                	ld	s4,80(sp)
    5bbc:	6aa6                	ld	s5,72(sp)
    5bbe:	6b06                	ld	s6,64(sp)
    5bc0:	7be2                	ld	s7,56(sp)
    5bc2:	7c42                	ld	s8,48(sp)
    5bc4:	7ca2                	ld	s9,40(sp)
    5bc6:	7d02                	ld	s10,32(sp)
    5bc8:	6de2                	ld	s11,24(sp)
    5bca:	6109                	addi	sp,sp,128
    5bcc:	8082                	ret

0000000000005bce <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    5bce:	715d                	addi	sp,sp,-80
    5bd0:	ec06                	sd	ra,24(sp)
    5bd2:	e822                	sd	s0,16(sp)
    5bd4:	1000                	addi	s0,sp,32
    5bd6:	e010                	sd	a2,0(s0)
    5bd8:	e414                	sd	a3,8(s0)
    5bda:	e818                	sd	a4,16(s0)
    5bdc:	ec1c                	sd	a5,24(s0)
    5bde:	03043023          	sd	a6,32(s0)
    5be2:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    5be6:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5bea:	8622                	mv	a2,s0
    5bec:	00000097          	auipc	ra,0x0
    5bf0:	e04080e7          	jalr	-508(ra) # 59f0 <vprintf>
}
    5bf4:	60e2                	ld	ra,24(sp)
    5bf6:	6442                	ld	s0,16(sp)
    5bf8:	6161                	addi	sp,sp,80
    5bfa:	8082                	ret

0000000000005bfc <printf>:

void
printf(const char *fmt, ...)
{
    5bfc:	711d                	addi	sp,sp,-96
    5bfe:	ec06                	sd	ra,24(sp)
    5c00:	e822                	sd	s0,16(sp)
    5c02:	1000                	addi	s0,sp,32
    5c04:	e40c                	sd	a1,8(s0)
    5c06:	e810                	sd	a2,16(s0)
    5c08:	ec14                	sd	a3,24(s0)
    5c0a:	f018                	sd	a4,32(s0)
    5c0c:	f41c                	sd	a5,40(s0)
    5c0e:	03043823          	sd	a6,48(s0)
    5c12:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5c16:	00840613          	addi	a2,s0,8
    5c1a:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5c1e:	85aa                	mv	a1,a0
    5c20:	4505                	li	a0,1
    5c22:	00000097          	auipc	ra,0x0
    5c26:	dce080e7          	jalr	-562(ra) # 59f0 <vprintf>
}
    5c2a:	60e2                	ld	ra,24(sp)
    5c2c:	6442                	ld	s0,16(sp)
    5c2e:	6125                	addi	sp,sp,96
    5c30:	8082                	ret

0000000000005c32 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    ...
    5c34:	e422                	sd	s0,8(sp)
    5c36:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5c38:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5c3c:	00003797          	auipc	a5,0x3
    5c40:	9bc7b783          	ld	a5,-1604(a5) # 85f8 <freep>
    5c44:	a02d                	j	5c6e <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5c46:	4618                	lw	a4,8(a2)
    5c48:	9f2d                	addw	a4,a4,a1
    5c4a:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5c4e:	6398                	ld	a4,0(a5)
    5c50:	6310                	ld	a2,0(a4)
    5c52:	a83d                	j	5c90 <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5c54:	ff852703          	lw	a4,-8(a0)
    5c58:	9f31                	addw	a4,a4,a2
    5c5a:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    5c5c:	ff053683          	ld	a3,-16(a0)
    5c60:	a091                	j	5ca4 <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c62:	6398                	ld	a4,0(a5)
    5c64:	00e7e463          	bltu	a5,a4,5c6c <free+0x3a>
    5c68:	00e6ea63          	bltu	a3,a4,5c7c <free+0x4a>
{
    5c6c:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5c6e:	fed7fae3          	bgeu	a5,a3,5c62 <free+0x30>
    5c72:	6398                	ld	a4,0(a5)
    5c74:	00e6e463          	bltu	a3,a4,5c7c <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c78:	fee7eae3          	bltu	a5,a4,5c6c <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    5c7c:	ff852583          	lw	a1,-8(a0)
    5c80:	6390                	ld	a2,0(a5)
    5c82:	02059813          	slli	a6,a1,0x20
    5c86:	01c85713          	srli	a4,a6,0x1c
    5c8a:	9736                	add	a4,a4,a3
    5c8c:	fae60de3          	beq	a2,a4,5c46 <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    5c90:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5c94:	4790                	lw	a2,8(a5)
    5c96:	02061593          	slli	a1,a2,0x20
    5c9a:	01c5d713          	srli	a4,a1,0x1c
    5c9e:	973e                	add	a4,a4,a5
    5ca0:	fae68ae3          	beq	a3,a4,5c54 <free+0x22>
    p->s.ptr = bp->s.ptr;
    5ca4:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    5ca6:	00003717          	auipc	a4,0x3
    5caa:	94f73923          	sd	a5,-1710(a4) # 85f8 <freep>
}
    5cae:	6422                	ld	s0,8(sp)
    5cb0:	0141                	addi	sp,sp,16
    5cb2:	8082                	ret

0000000000005cb4 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    5cb4:	7139                	addi	sp,sp,-64
    5cb6:	fc06                	sd	ra,56(sp)
    5cb8:	f822                	sd	s0,48(sp)
    5cba:	f426                	sd	s1,40(sp)
    5cbc:	f04a                	sd	s2,32(sp)
    5cbe:	ec4e                	sd	s3,24(sp)
    5cc0:	e852                	sd	s4,16(sp)
    5cc2:	e456                	sd	s5,8(sp)
    5cc4:	e05a                	sd	s6,0(sp)
    5cc6:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5cc8:	02051493          	slli	s1,a0,0x20
    5ccc:	9081                	srli	s1,s1,0x20
    5cce:	04bd                	addi	s1,s1,15
    5cd0:	8091                	srli	s1,s1,0x4
    5cd2:	0014899b          	addiw	s3,s1,1
    5cd6:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    5cd8:	00003517          	auipc	a0,0x3
    5cdc:	92053503          	ld	a0,-1760(a0) # 85f8 <freep>
    5ce0:	c515                	beqz	a0,5d0c <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5ce2:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5ce4:	4798                	lw	a4,8(a5)
    5ce6:	02977f63          	bgeu	a4,s1,5d24 <malloc+0x70>
    5cea:	8a4e                	mv	s4,s3
    5cec:	0009871b          	sext.w	a4,s3
    5cf0:	6685                	lui	a3,0x1
    5cf2:	00d77363          	bgeu	a4,a3,5cf8 <malloc+0x44>
    5cf6:	6a05                	lui	s4,0x1
    5cf8:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    5cfc:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    5d00:	00003917          	auipc	s2,0x3
    5d04:	8f890913          	addi	s2,s2,-1800 # 85f8 <freep>
  if(p == (char*)-1)
    5d08:	5afd                	li	s5,-1
    5d0a:	a895                	j	5d7e <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    5d0c:	00009797          	auipc	a5,0x9
    5d10:	10c78793          	addi	a5,a5,268 # ee18 <base>
    5d14:	00003717          	auipc	a4,0x3
    5d18:	8ef73223          	sd	a5,-1820(a4) # 85f8 <freep>
    5d1c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5d1e:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5d22:	b7e1                	j	5cea <malloc+0x36>
      if(p->s.size == nunits)
    5d24:	02e48c63          	beq	s1,a4,5d5c <malloc+0xa8>
        p->s.size -= nunits;
    ...
    5d40:	8aa73e23          	sd	a0,-1860(a4) # 85f8 <freep>
      return (void*)(p + 1);
    ...
    5d52:	6a42                	ld	s4,16(sp)
    5d54:	6aa2                	ld	s5,8(sp)
    5d56:	6b02                	ld	s6,0(sp)
    5d58:	6121                	addi	sp,sp,64
    5d5a:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    5d5c:	6398                	ld	a4,0(a5)
    5d5e:	e118                	sd	a4,0(a0)
    5d60:	bff1                	j	5d3c <malloc+0x88>
  hp->s.size = nu;
    5d62:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5d66:	0541                	addi	a0,a0,16
    5d68:	00000097          	auipc	ra,0x0
    5d6c:	eca080e7          	jalr	-310(ra) # 5c32 <free>
  return freep;
    5d70:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    5d74:	d971                	beqz	a0,5d48 <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5d76:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5d78:	4798                	lw	a4,8(a5)
    5d7a:	fa9775e3          	bgeu	a4,s1,5d24 <malloc+0x70>
    if(p == freep)
    5d7e:	00093703          	ld	a4,0(s2)
    5d82:	853e                	mv	a0,a5
    5d84:	fef719e3          	bne	a4,a5,5d76 <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
    5d88:	8552                	mv	a0,s4
    5d8a:	00000097          	auipc	ra,0x0
    5d8e:	b40080e7          	jalr	-1216(ra) # 58ca <sbrk>
  if(p == (char*)-1)
    5d92:	fd5518e3          	bne	a0,s5,5d62 <malloc+0xae>
        return 0;
    5d96:	4501                	li	a0,0
    5d98:	bf45                	j	5d48 <malloc+0x94>
