...
main(int argc, char *argv[])
{
  ...
  14:	81858593          	addi	a1,a1,-2024 # 828 <malloc+0xea>
  18:	4509                	li	a0,2
...
putc(int fd, char c)
{
 ...
 3c2:	f2e080e7          	jalr	-210(ra) # 2ec <write>
}
...
free(void *ap)
{
 ...
 6ca:	20a7b783          	ld	a5,522(a5) # 8d0 <freep>
 ...
 6f2:	00e6ea63          	bltu	a3,a4,706 <free+0x4a>
{
 ...
 734:	1af73023          	sd	a5,416(a4) # 8d0 <freep>
}
 738:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 78e:	14690913          	addi	s2,s2,326 # 8d0 <freep>
  if(p == (char*)-1)
 792:	5afd                	li	s5,-1
 794:	a895                	j	808 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 796:	00000797          	auipc	a5,0x0
 79a:	14278793          	addi	a5,a5,322 # 8d8 <base>
 79e:	00000717          	auipc	a4,0x0
 7a2:	12f73923          	sd	a5,306(a4) # 8d0 <freep>
 7a6:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 818:	b40080e7          	jalr	-1216(ra) # 354 <sbrk>
  if(p == (char*)-1)
