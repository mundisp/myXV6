...
cat(int fd)
{
  ...
  44:	8a858593          	addi	a1,a1,-1880 # 8e8 <malloc+0xec>
  48:	4509                	li	a0,2
  ...
  72:	89258593          	addi	a1,a1,-1902 # 900 <malloc+0x104>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 106:	81658593          	addi	a1,a1,-2026 # 918 <malloc+0x11c>
 10a:	4509                	li	a0,2
...
putc(int fd, char c)
{
 ...
 480:	f2e080e7          	jalr	-210(ra) # 3aa <write>
}
...
free(void *ap)
{
 ...
 788:	2247b783          	ld	a5,548(a5) # 9a8 <freep>
 ...
 7b0:	00e6ea63          	bltu	a3,a4,7c4 <free+0x4a>
{
 ...
 7f2:	1af73d23          	sd	a5,442(a4) # 9a8 <freep>
}
 7f6:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 824:	18853503          	ld	a0,392(a0) # 9a8 <freep>
 ...
 84c:	16090913          	addi	s2,s2,352 # 9a8 <freep>
  if(p == (char*)-1)
 850:	5afd                	li	s5,-1
 852:	a895                	j	8c6 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 854:	00000797          	auipc	a5,0x0
 858:	35c78793          	addi	a5,a5,860 # bb0 <base>
 85c:	00000717          	auipc	a4,0x0
 860:	14f73623          	sd	a5,332(a4) # 9a8 <freep>
 864:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 888:	12a73223          	sd	a0,292(a4) # 9a8 <freep>
      return (void*)(p + 1);
 ...
 8d6:	b40080e7          	jalr	-1216(ra) # 412 <sbrk>
  if(p == (char*)-1)
