...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4a2:	49a50513          	addi	a0,a0,1178 # 938 <digits>
 4a6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 562:	382c8c93          	addi	s9,s9,898 # 8e0 <malloc+0xf4>
 ...
 696:	24698993          	addi	s3,s3,582 # 8d8 <malloc+0xec>
        while(*s != 0){
 69a:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 778:	1dc7b783          	ld	a5,476(a5) # 950 <freep>
 ...
 7a0:	00e6ea63          	bltu	a3,a4,7b4 <free+0x4a>
{
 ...
 7e2:	16f73923          	sd	a5,370(a4) # 950 <freep>
}
 7e6:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 814:	14053503          	ld	a0,320(a0) # 950 <freep>
 ...
 83c:	11890913          	addi	s2,s2,280 # 950 <freep>
  if(p == (char*)-1)
 840:	5afd                	li	s5,-1
 842:	a895                	j	8b6 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 844:	00000797          	auipc	a5,0x0
 848:	11478793          	addi	a5,a5,276 # 958 <base>
 84c:	00000717          	auipc	a4,0x0
 850:	10f73223          	sd	a5,260(a4) # 950 <freep>
 854:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 878:	0ca73e23          	sd	a0,220(a4) # 950 <freep>
      return (void*)(p + 1);
