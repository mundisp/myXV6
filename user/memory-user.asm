...
int main(int argc, char *argv[]) {
  ...
  18:	1080                	addi	s0,sp,96
    if (argc != 4) {
  1a:	4791                	li	a5,4
  1c:	00f50f63          	beq	a0,a5,3a <main+0x3a>
  ...
  24:	8b850513          	addi	a0,a0,-1864 # 8d8 <malloc+0xec>
  28:	00000097          	auipc	ra,0x0
  2c:	70c080e7          	jalr	1804(ra) # 734 <printf>
        exit(-1);
  30:	557d                	li	a0,-1
  32:	00000097          	auipc	ra,0x0
  36:	360080e7          	jalr	864(ra) # 392 <exit>
  3a:	84ae                	mv	s1,a1
    }
  ...
  42:	25a080e7          	jalr	602(ra) # 298 <atoi>
  46:	0005091b          	sext.w	s2,a0
    uint limit = atoi(argv[2]);
  4a:	6888                	ld	a0,16(s1)
  4c:	00000097          	auipc	ra,0x0
  50:	24c080e7          	jalr	588(ra) # 298 <atoi>
  54:	0005099b          	sext.w	s3,a0
    uint increment = atoi(argv[3]);
  58:	6c88                	ld	a0,24(s1)
  5a:	00000097          	auipc	ra,0x0
  5e:	23e080e7          	jalr	574(ra) # 298 <atoi>
  ...
  66:	0b29eb63          	bltu	s3,s2,11c <main+0x11c>
	printf("allocating %p megabytes\n", i); 
  6a:	00001b17          	auipc	s6,0x1
  6e:	8feb0b13          	addi	s6,s6,-1794 # 968 <malloc+0x17c>
	array = (int *) malloc(i*1024*1024);
	printf("malloc returned %p\n", array);
  72:	00001a97          	auipc	s5,0x1
  76:	916a8a93          	addi	s5,s5,-1770 # 988 <malloc+0x19c>
        if (!array) {
  ...
  80:	934b8b93          	addi	s7,s7,-1740 # 9b0 <malloc+0x1c4>
  84:	a889                	j	d6 <main+0xd6>
            printf("malloc failed\n");
  86:	00001517          	auipc	a0,0x1
  8a:	91a50513          	addi	a0,a0,-1766 # 9a0 <malloc+0x1b4>
  8e:	00000097          	auipc	ra,0x0
  92:	6a6080e7          	jalr	1702(ra) # 734 <printf>
	    exit(-1);
  96:	557d                	li	a0,-1
  98:	00000097          	auipc	ra,0x0
  9c:	2fa080e7          	jalr	762(ra) # 392 <exit>
	sleep(50);
  a0:	03200513          	li	a0,50
  a4:	00000097          	auipc	ra,0x0
  a8:	37e080e7          	jalr	894(ra) # 422 <sleep>
	printf("freeing %p megabytes\n", i); 
  ac:	85ca                	mv	a1,s2
  ae:	855e                	mv	a0,s7
  b0:	00000097          	auipc	ra,0x0
  b4:	684080e7          	jalr	1668(ra) # 734 <printf>
	free(array);
  b8:	8526                	mv	a0,s1
  ba:	00000097          	auipc	ra,0x0
  be:	6b0080e7          	jalr	1712(ra) # 76a <free>
	sleep(50);
  c2:	03200513          	li	a0,50
  c6:	00000097          	auipc	ra,0x0
  ca:	35c080e7          	jalr	860(ra) # 422 <sleep>
    for (i=start; i<=limit; i+=increment) {
  ce:	012a093b          	addw	s2,s4,s2
  d2:	0529e563          	bltu	s3,s2,11c <main+0x11c>
	printf("allocating %p megabytes\n", i); 
  d6:	85ca                	mv	a1,s2
  d8:	855a                	mv	a0,s6
  da:	00000097          	auipc	ra,0x0
  de:	65a080e7          	jalr	1626(ra) # 734 <printf>
	array = (int *) malloc(i*1024*1024);
  e2:	01491c9b          	slliw	s9,s2,0x14
  e6:	000c851b          	sext.w	a0,s9
  ea:	00000097          	auipc	ra,0x0
  ee:	702080e7          	jalr	1794(ra) # 7ec <malloc>
  f2:	84aa                	mv	s1,a0
	printf("malloc returned %p\n", array);
  f4:	85aa                	mv	a1,a0
  f6:	8556                	mv	a0,s5
  f8:	00000097          	auipc	ra,0x0
  fc:	63c080e7          	jalr	1596(ra) # 734 <printf>
        if (!array) {
 100:	d0d9                	beqz	s1,86 <main+0x86>
	for (j = 0; j <= i*1024*1024/4; j++){
 102:	002cd61b          	srliw	a2,s9,0x2
 106:	2601                	sext.w	a2,a2
 108:	8726                	mv	a4,s1
 10a:	87e2                	mv	a5,s8
	    array[j] = j;
 10c:	c31c                	sw	a5,0(a4)
 ...
 114:	0711                	addi	a4,a4,4
 116:	fed61be3          	bne	a2,a3,10c <main+0x10c>
 11a:	b759                	j	a0 <main+0xa0>
    }
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4a2:	58a50513          	addi	a0,a0,1418 # a28 <digits>
 4a6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 562:	472c8c93          	addi	s9,s9,1138 # 9d0 <malloc+0x1e4>
 ...
 570:	4bcb8b93          	addi	s7,s7,1212 # a28 <digits>
 ...
 696:	33698993          	addi	s3,s3,822 # 9c8 <malloc+0x1dc>
        while(*s != 0){
 69a:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 778:	2cc7b783          	ld	a5,716(a5) # a40 <freep>
 ...
 7a0:	00e6ea63          	bltu	a3,a4,7b4 <free+0x4a>
{
 ...
 7e2:	26f73123          	sd	a5,610(a4) # a40 <freep>
}
 7e6:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 814:	23053503          	ld	a0,560(a0) # a40 <freep>
 ...
 83c:	20890913          	addi	s2,s2,520 # a40 <freep>
  if(p == (char*)-1)
 840:	5afd                	li	s5,-1
 842:	a895                	j	8b6 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 844:	00000797          	auipc	a5,0x0
 848:	20478793          	addi	a5,a5,516 # a48 <base>
 84c:	00000717          	auipc	a4,0x0
 850:	1ef73a23          	sd	a5,500(a4) # a40 <freep>
 854:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 878:	1ca73623          	sd	a0,460(a4) # a40 <freep>
      return (void*)(p + 1);
