...
putc(int fd, char c)
{
 ...
 3da:	f2e080e7          	jalr	-210(ra) # 304 <write>
}
...
free(void *ap)
{
 ...
 6e2:	2127b783          	ld	a5,530(a5) # 8f0 <freep>
 ...
 70a:	00e6ea63          	bltu	a3,a4,71e <free+0x4a>
{
 ...
 74c:	1af73423          	sd	a5,424(a4) # 8f0 <freep>
}
 750:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 77e:	17653503          	ld	a0,374(a0) # 8f0 <freep>
 ...
 7a6:	14e90913          	addi	s2,s2,334 # 8f0 <freep>
  if(p == (char*)-1)
 7aa:	5afd                	li	s5,-1
 7ac:	a895                	j	820 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 7ae:	00000797          	auipc	a5,0x0
 7b2:	14a78793          	addi	a5,a5,330 # 8f8 <base>
 7b6:	00000717          	auipc	a4,0x0
 7ba:	12f73d23          	sd	a5,314(a4) # 8f0 <freep>
 7be:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7e2:	10a73923          	sd	a0,274(a4) # 8f0 <freep>
      return (void*)(p + 1);
 ...
 830:	b40080e7          	jalr	-1216(ra) # 36c <sbrk>
  if(p == (char*)-1)
